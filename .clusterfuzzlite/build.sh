...
ls fuzz_* | while read i; do
    ...
    wget "https://storage.googleapis.com/suricata-backup.clusterfuzz-external.appspot.com/corpus/libFuzzer/suricata_$i/public.zip";
    mv public.zip $OUT/$i_seed_corpus.zip
done
)
# dictionaries
