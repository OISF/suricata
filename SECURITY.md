...
We are interested in security issues in Suricata tool itself.
If you find a security issue in Suricata API, we can review
...
Usually, the best reproducer is a suricata-verify test.
