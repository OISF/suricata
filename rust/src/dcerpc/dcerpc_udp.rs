...
use crate::dcerpc::dcerpc::{
    rs_dcerpc_get_alstate_progress, DCERPCTransaction, ALPROTO_DCERPC, DCERPC_MAX_TX,
...
#[no_mangle]
pub extern "C" fn rs_dcerpc_udp_state_new(
...
pub unsafe extern "C" fn rs_dcerpc_probe_udp(
