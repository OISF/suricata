...
mod tests {
    ...
    fn test_process_header() {
        let request: &[u8] = &[
            0x05, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ];
    ...
    fn test_handle_bindctxitem() {
        ...
        let bind: &[u8] = &[
            ...
            0xeb, 0x1c, 0xc9, 0x11, 0x9f, 0xe8, 0x08, 0x00, 0x2b, 0x10, 0x48, 0x60, 0x02, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00
        ];
        let mut dcerpc_state = DCERPCState::new();
        assert_eq!(16, dcerpc_state.process_header(header));
    ...
    pub fn test_bind_acks_alter_contexts_internal_ids() {
        ...
        println!("bindack state: {:?}", dcerpc_state.bindack);
