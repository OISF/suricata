...
impl DCERPCState {
    ...
    pub fn get_tx_by_call_id(
        &mut self, call_id: u32, dir: Direction,
    ...
    pub fn handle_common_stub(
        &mut self, input: &[u8], bytes_consumed: usize, dir: Direction,
    ) -> i32 {
        ...
        match self.get_hdr_type() {
            Some(x) => match x {
                ...
                DCERPC_TYPE_RESPONSE => {
                    ...
                    retval =
                        self.handle_common_stub(&buffer[parsed as usize..], 0, Direction::ToClient);
                    if retval < 0 {
                        return AppLayerResult::err();
                    }
                }
