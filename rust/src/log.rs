...
pub fn sclog(level: Level, file: &str, line: u32, function: &str, code: i32, message: &str) {
...
pub fn sc_log_message(
    level: Level, filename: &str, line: std::os::raw::c_uint, function: &str,
    code: std::os::raw::c_int, message: &str,
) -> std::os::raw::c_int {
    unsafe {
        if let Some(c) = SC {
