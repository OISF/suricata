...
use crate::applayer::*;
use crate::core::{self, AppProto, ALPROTO_UNKNOWN, IPPROTO_TCP, IPPROTO_UDP};
...
#[no_mangle]
pub unsafe extern fn rs_dns_state_get_event_info_by_id(
...
#[no_mangle]
pub unsafe extern fn rs_dns_state_get_event_info(
...
fn probe(input: &[u8], dlen: usize) -> (bool, bool, bool) {
    ...
    match parser::dns_parse_request(i2) {
        ...
        Err(nom::Err::Incomplete(_)) => match parser::dns_parse_header(input) {
            Ok((_, header)) => {
...
#[no_mangle]
pub extern fn rs_dns_state_new(
...
/// Returns *mut DNSState
#[no_mangle]
pub extern fn rs_dns_state_tcp_new() -> *mut std::os::raw::c_void {
...
#[no_mangle]
pub extern fn rs_dns_state_free(state: *mut std::os::raw::c_void) {
    // Just unbox...
    std::mem::drop(unsafe { Box::from_raw(state as *mut DNSState) });
}

#[no_mangle]
pub unsafe extern fn rs_dns_state_tx_free(state: *mut std::os::raw::c_void, tx_id: u64) {
...
#[no_mangle]
pub unsafe extern fn rs_dns_parse_request(
...
#[no_mangle]
pub unsafe extern fn rs_dns_parse_response(
    _flow: *const core::Flow, state: *mut std::os::raw::c_void, _pstate: *mut std::os::raw::c_void,
    input: *const u8, input_len: u32, _data: *const std::os::raw::c_void, _flags: u8,
) -> AppLayerResult {
    let state = cast_pointer!(state, DNSState);
...
/// C binding parse a DNS request. Returns 1 on success, -1 on failure.
#[no_mangle]
pub unsafe extern fn rs_dns_parse_request_tcp(
    _flow: *const core::Flow, state: *mut std::os::raw::c_void, _pstate: *mut std::os::raw::c_void,
    input: *const u8, input_len: u32, _data: *const std::os::raw::c_void, _flags: u8,
) -> AppLayerResult {
    let state = cast_pointer!(state, DNSState);
...
#[no_mangle]
pub unsafe extern fn rs_dns_parse_response_tcp(
    _flow: *const core::Flow, state: *mut std::os::raw::c_void, _pstate: *mut std::os::raw::c_void,
    input: *const u8, input_len: u32, _data: *const std::os::raw::c_void, _flags: u8,
) -> AppLayerResult {
    let state = cast_pointer!(state, DNSState);
...
#[no_mangle]
pub extern fn rs_dns_tx_get_alstate_progress(
...
#[no_mangle]
pub unsafe extern fn rs_dns_state_get_tx_count(state: *mut std::os::raw::c_void) -> u64 {
    let state = cast_pointer!(state, DNSState);
...
#[no_mangle]
pub unsafe extern fn rs_dns_state_get_tx(
...
#[no_mangle]
pub extern fn rs_dns_tx_is_request(tx: &mut DNSTransaction) -> bool {
    tx.request.is_some()
}

#[no_mangle]
pub extern fn rs_dns_tx_is_response(tx: &mut DNSTransaction) -> bool {
    tx.response.is_some()
}

#[no_mangle]
pub unsafe extern fn rs_dns_state_set_tx_detect_state(
...
#[no_mangle]
pub unsafe extern fn rs_dns_state_get_tx_detect_state(
...
#[no_mangle]
pub unsafe extern fn rs_dns_state_get_events(
    tx: *mut std::os::raw::c_void,
...
#[no_mangle]
pub unsafe extern fn rs_dns_state_get_tx_data(
    tx: *mut std::os::raw::c_void,
) -> *mut AppLayerTxData {
    let tx = cast_pointer!(tx, DNSTransaction);
...
#[no_mangle]
pub unsafe extern fn rs_dns_tx_get_query_name(
...
#[no_mangle]
pub extern fn rs_dns_tx_get_tx_id(tx: &mut DNSTransaction) -> u16 {
    return tx.tx_id();
}
...
#[no_mangle]
pub extern fn rs_dns_tx_get_response_flags(tx: &mut DNSTransaction) -> u16 {
    return tx.rcode();
}

#[no_mangle]
pub unsafe extern fn rs_dns_tx_get_query_rrtype(
...
#[no_mangle]
pub unsafe extern fn rs_dns_probe(
...
#[no_mangle]
pub unsafe extern fn rs_dns_probe_tcp(
...
#[no_mangle]
pub unsafe extern fn rs_dns_apply_tx_config(
...
#[no_mangle]
pub unsafe extern fn rs_dns_udp_register_parser() {
...
#[no_mangle]
pub unsafe extern fn rs_dns_tcp_register_parser() {
    let default_port = std::ffi::CString::new("53").unwrap();
    let parser = RustParser {
        name: b"dns\0".as_ptr() as *const std::os::raw::c_char,
        default_port: default_port.as_ptr(),
...
mod tests {
    ...
    fn test_dns_parse_request_tcp_valid() {
        ...
        assert_eq!(AppLayerResult::ok(), state.parse_request_tcp(&request));
    }
    ...
    fn test_dns_parse_response_tcp_valid() {
        ...
        let mut state = DNSState::new();
        assert_eq!(AppLayerResult::ok(), state.parse_response_tcp(&request));
    }
    ...
    fn test_dns_udp_parser_test_01() {
         ...
         * ns, hostmaster */
        let buf: &[u8] = &[
            0x00, 0x3c, 0x85, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x0b, 0x61,
            0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6a, 0x6b, 0x03, 0x63, 0x6f, 0x6d,
            0x00, 0x00, 0x0f, 0x00, 0x01, 0x00, 0x00, 0x06, 0x00, 0x01, 0x00, 0x01, 0x51, 0x80,
            0x00, 0x25, 0x02, 0x6e, 0x73, 0x00, 0x0a, 0x68, 0x6f, 0x73, 0x74, 0x6d, 0x61, 0x73,
            0x74, 0x65, 0x72, 0xc0, 0x2f, 0x01, 0x33, 0x2a, 0x76, 0x00, 0x00, 0x70, 0x80, 0x00,
            0x00, 0x1c, 0x20, 0x00, 0x09, 0x3a, 0x80, 0x00, 0x01, 0x51, 0x80,
        ];
        let mut state = DNSState::new();
    ...
    fn test_dns_udp_parser_test_02() {
        let buf: &[u8] = &[
            ,
    ...
    fn test_dns_udp_parser_test_03() {
        let buf: &[u8] = &[
            ,
        ];
        let mut state = DNSState::new();
        assert!(state.parse_response(buf));
    }
    ...
    fn test_dns_udp_parser_test_04() {
        let buf: &[u8] = &[
            0xc2, 0x2f, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x0a, 0x41,
            0x41, 0x41, 0x41, 0x41, 0x4f, 0x31, 0x6b, 0x51, 0x41, 0x05, 0x3d, 0x61, 0x75, 0x74,
            0x68, 0x03, 0x73, 0x72, 0x76, 0x06, 0x74, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x03, 0x63,
            0x6f, 0x6d, 0x00, 0x00, 0x10, 0x00, 0x01, /* answer record start */
            0xc0, 0x0c, 0x00, 0x10, 0x00, 0x01, 0x00, 0x00, 0x00, 0x03, 0x00, 0x22,
            /* txt record starts: */
            0x20, /* <txt len 32 */ 0x41, 0x68, 0x76, 0x4d, 0x41, 0x41, 0x4f, 0x31, 0x6b, 0x41,
            0x46, 0x45, 0x35, 0x54, 0x45, 0x39, 0x51, 0x54, 0x6a, 0x46, 0x46, 0x4e, 0x30, 0x39,
            0x52, 0x4e, 0x31, 0x6c, 0x59, 0x53, 0x44, 0x6b, 0x00, /* <txt len 0 */ 0xc0, 0x1d,
            0x00, 0x02, 0x00, 0x01, 0x00, 0x09, 0x3a, 0x80, 0x00, 0x09, 0x06, 0x69, 0x6f, 0x64,
            0x69, 0x6e, 0x65, 0xc0, 0x21, 0xc0, 0x6b, 0x00, 0x01, 0x00, 0x01, 0x00, 0x09, 0x3a,
            0x80, 0x00, 0x04, 0x0a, 0x1e, 0x1c, 0x5f,
        ];
        let mut state = DNSState::new();
        assert!(state.parse_response(buf));
    }
    ...
    fn test_dns_udp_parser_test_05() {
        let buf: &[u8] = &[
            ...
            0xc0, 0x0c, 0x00, 0x10, 0x00, 0x01, 0x00, 0x00, 0x00, 0x03, 0x00, 0x22,
            /* txt record starts: */
            0x40, /* <txt len 64 */ 0x41, 0x68, 0x76, 0x4d, 0x41, 0x41, 0x4f, 0x31, 0x6b, 0x41,
            0x46, 0x45, 0x35, 0x54, 0x45, 0x39, 0x51, 0x54, 0x6a, 0x46, 0x46, 0x4e, 0x30, 0x39,
            0x52, 0x4e, 0x31, 0x6c, 0x59, 0x53, 0x44, 0x6b, 0x00, /* <txt len 0 */ 0xc0, 0x1d,
            0x00, 0x02, 0x00, 0x01, 0x00, 0x09, 0x3a, 0x80, 0x00, 0x09, 0x06, 0x69, 0x6f, 0x64,
            0x69, 0x6e, 0x65, 0xc0, 0x21, 0xc0, 0x6b, 0x00, 0x01, 0x00, 0x01, 0x00, 0x09, 0x3a,
    ...
    fn test_dns_tcp_parser_multi_record() {
        let buf: &[u8] = &[
            ,
        ];
        let mut state = DNSState::new();
        assert_eq!(AppLayerResult::ok(), state.parse_request_tcp(buf));
    }
    ...
    fn test_dns_tcp_parser_split_payload() {
        /* incomplete payload */
        let buf1: &[u8] = &[
            0x00, 0x1c, 0x10, 0x32, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ];
        /* complete payload plus the start of a new payload */
        let buf2: &[u8] = &[
            0x00, 0x1c, 0x10, 0x32, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x06, 0x67, 0x6F, 0x6F, 0x67, 0x6C, 0x65, 0x03, 0x63, 0x6F, 0x6D, 0x00, 0x00, 0x10,
            0x00, 0x01, // next.
            0x00, 0x1c, 0x10, 0x32, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ];
        ...
        assert_eq!(AppLayerResult::ok(), state.parse_request_tcp(buf3));
    }
}
