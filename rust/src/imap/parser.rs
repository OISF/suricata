...
fn parse_untagged_response(i: &[u8]) -> IResult<&[u8], ImapMessage> {
    ...
    let (i, data, fetch_data) = if is_fetch {
...
pub fn parse_email_headers(mut i: &[u8]) -> IResult<&[u8], HashMap<String, String>> {
...
mod tests {
    ...
    fn test_parse_email_content() {
        ...
        assert_eq!(result.headers.get("Subject"), Some(&"Hello".to_string()));
