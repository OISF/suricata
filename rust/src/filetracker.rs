...
impl FileTransferTracker {
    ...
    fn open(&mut self, config: &'static SuricataFileContext,
            files: &mut SuricataFileContainer, flags: u16, name: &[u8]) -> i32
    {
    ...
    pub fn close(&mut self, files: &mut SuricataFileContainer, flags: u16) {
    ...
    pub fn new_chunk(&mut self, config: &'static SuricataFileContext,
            files: &mut SuricataFileContainer, flags: u16,
    ...
    pub fn update(&mut self, files: &mut SuricataFileContainer, flags: u16, data: &[u8]) -> u32 {
