...
fn log_bittorrent_dht(
    ...
    if let Some(request) = &tx.request {
        ...
        /* TODO should implied_port & port just be combined into single port
         * value using UDP source port if port is implied or DHT port otherwise?
         * How can we attach the associated source UDP port from the
         * request packet to our BitTorrentDHTTransaction so we can have this
         * logic here? */
...
#[no_mangle]
pub extern "C" fn rs_bittorrent_dht_logger_log(
