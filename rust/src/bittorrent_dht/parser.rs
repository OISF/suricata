...
mod tests {
    ...
    #[test_case(
        ...
        "Error: malformed content discovered: number too large to fit in target type in implied_port" ;
    ...
    #[test_case(
        ...
        "Error: malformed content discovered: invalid digit found in string in implied_port" ;
    ...
    #[test_case(
        ...
        "Error: malformed content discovered: number too large to fit in target type in port" ;
    ...
    #[test_case(
        ...
        "Error: malformed content discovered: invalid digit found in string in port" ;
    ...
    #[test_case(
        b"li999999ee",
        "Error: malformed content discovered: number too large to fit in target type in num" ;
        "test error from bencode err 3")]
    #[test_case(
        b"li-1ee",
        "Error: malformed content discovered: invalid digit found in string in num" ;
