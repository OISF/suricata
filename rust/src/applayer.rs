...
pub use suricata_sys::sys::{
    AppLayerGetFileState, AppLayerGetTxIterState, AppLayerGetTxIterTuple, AppLayerResult,
    AppLayerStateData, AppLayerTxConfig, AppLayerTxData, StreamSlice,
};
...
#[cfg(test)]
pub trait StreamSliceTest {
    fn from_slice(slice: &[u8], flags: u8, offset: u64) -> Self;
}

#[cfg(test)]
impl StreamSliceTest for StreamSlice {
