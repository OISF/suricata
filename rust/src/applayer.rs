...
extern {
    pub fn AppLayerFrameNew2(flow: *const Flow, stream_slice: *const StreamSlice, frame_start_rel: u32, len: i32, dir: i32, frame_type: u8) -> *const Frame;
        ...
        flow: *const Flow, stream_slice: &StreamSlice, frame_start: &[u8], frame_len: i32, dir: i32, frame_type: u8) -> (*const Frame, i64)
{
    ...
    let frame = unsafe { AppLayerFrameNew2(flow, stream_slice, offset as u32, frame_len, dir, frame_type) };
