...
use crate::applayer;
use crate::core::SC;
use crate::core::{AppLayerDecoderEvents, AppLayerEventType, AppProto, DetectEngineState, Flow};
...
pub type GetDetectStateFn = unsafe extern fn(*mut c_void) -> *mut DetectEngineState;
pub type SetDetectStateFn = unsafe extern fn(*mut c_void, &mut DetectEngineState) -> c_int;
...
pub type GetEventsFn = unsafe extern fn(*mut c_void) -> *mut AppLayerDecoderEvents;
pub type LocalStorageNewFn = extern fn() -> *mut c_void;
pub type LocalStorageFreeFn = extern fn(*mut c_void);
pub type GetFilesFn = unsafe extern fn(*mut c_void, u8) -> *mut FileContainer;
...
pub type AppLayerGetTxIteratorFn = unsafe extern fn(
    ipproto: u8,
    alproto: AppProto,
    alstate: *mut c_void,
    min_tx_id: u64,
...
extern {
    ...
    pub fn AppLayerParserRegisterGetTxIterator(
        ipproto: u8, alproto: AppProto, fun: AppLayerGetTxIteratorFn,
    );
...
macro_rules! export_tx_get_detect_state {
    ($name:ident, $type:ty) => {
        #[no_mangle]
        pub unsafe extern fn $name(tx: *mut std::os::raw::c_void) -> *mut core::DetectEngineState {
