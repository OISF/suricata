...
pub const APP_LAYER_PARSER_EOF_TS : u16 = 0x0020; //BIT_U16!(5);
pub const APP_LAYER_PARSER_EOF_TC : u16 = 0x0040; //BIT_U16!(6);

pub const APP_LAYER_PARSER_OPT_ACCEPT_GAPS: u32 = 1; // BIT_U32!(0);
