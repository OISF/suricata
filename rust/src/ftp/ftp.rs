...
#[no_mangle]
pub unsafe extern "C" fn rs_ftp_get_config_values(memcap: *mut u64, max_tx: *mut u32, max_line_len: *mut u32) {
...
#[no_mangle]
pub unsafe extern "C" fn rs_ftp_transfer_cmd_new() -> *mut FtpTransferCmd {
...
#[no_mangle]
pub unsafe extern "C" fn rs_ftp_transfer_cmd_free(cmd: *mut FtpTransferCmd) {
