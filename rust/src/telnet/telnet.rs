...
#[no_mangle]
pub unsafe extern fn rs_telnet_probing_parser(
...
#[no_mangle]
pub extern fn rs_telnet_state_new(
...
#[no_mangle]
pub unsafe extern fn rs_telnet_state_free(state: *mut std::os::raw::c_void) {
    std::mem::drop(Box::from_raw(state as *mut TelnetState));
}

#[no_mangle]
pub unsafe extern fn rs_telnet_state_tx_free(state: *mut std::os::raw::c_void, tx_id: u64) {
    let state = cast_pointer!(state, TelnetState);
    state.free_tx(tx_id);
}

#[no_mangle]
pub unsafe extern fn rs_telnet_parse_request(
...
#[no_mangle]
pub unsafe extern fn rs_telnet_parse_response(
    flow: *const Flow, state: *mut std::os::raw::c_void, pstate: *mut std::os::raw::c_void,
    stream_slice: StreamSlice, _data: *const std::os::raw::c_void,
) -> AppLayerResult {
...
#[no_mangle]
pub unsafe extern fn rs_telnet_state_get_tx(
...
#[no_mangle]
pub unsafe extern fn rs_telnet_state_get_tx_count(state: *mut std::os::raw::c_void) -> u64 {
    let state = cast_pointer!(state, TelnetState);
    return state.tx_id;
}

#[no_mangle]
pub unsafe extern fn rs_telnet_tx_get_alstate_progress(
...
#[no_mangle]
pub unsafe extern fn rs_telnet_register_parser() {
