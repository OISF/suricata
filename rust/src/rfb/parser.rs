...
#[cfg(test)]
mod tests {
    use x509_parser::oid_registry::asn1_rs::ToDer;
    ...
    fn test_parse_server_init() {
        let buf = [
            0x05, 0x00, /* Width: 800 */
            0x03, 0x20, /* Height: 600 */
            0x20, /* Bits per pixel: 32 */
            0x18, 0x00, 0x01, 0x00, 0xff, 0x00, 0xff, 0x00, 0xff, 0x10, 0x08, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x1e, 0x61, 0x6e, 0x65, 0x61, 0x67, 0x6c, 0x65, 0x73, 0x40,
            0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x68, 0x6f, 0x73, 0x74, 0x2e, 0x6c, 0x6f, 0x63, 0x61,
            0x6c, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e,
        ];
