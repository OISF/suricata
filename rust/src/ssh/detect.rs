...
use super::ssh::{SCSshEnableHassh, SSHConnectionState, SSHTransaction, ALPROTO_SSH};
...
pub unsafe extern "C" fn SCDetectSshRegister() {
    ...
    let ssh_hassh_str_kw_id = helper_keyword_register_sticky_buffer(&kw);
    ...
    let ssh_hassh_server_str_kw_id = helper_keyword_register_sticky_buffer(&kw);
