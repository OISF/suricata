...
#[no_mangle]
pub extern "C" fn rs_tftp_state_tx_free(state: &mut TFTPState, tx_id: u64) {
    state.free_tx(tx_id);
}

#[no_mangle]
pub extern "C" fn rs_tftp_get_tx(state: &mut TFTPState, tx_id: u64) -> *mut std::os::raw::c_void {
...
fn getstr(i: &[u8]) -> IResult<&[u8], &str> {
    map_res(take_while(|c| c != 0), str::from_utf8)(i)
}
...
#[no_mangle]
pub unsafe extern "C" fn rs_tftp_request(state: &mut TFTPState, input: *const u8, len: u32) -> i64 {
...
#[no_mangle]
pub unsafe extern "C" fn rs_tftp_get_tx_data(tx: *mut std::os::raw::c_void) -> *mut AppLayerTxData {
