...
pub struct DetectByteMathData {
    pub rvalue_str: *const c_char,
    pub result: *const c_char,
    pub rvalue: u32,
    pub flags: u32,
    pub offset: i32,
    pub bitmask_val: u32,
    pub bitmask_shift_count: u16,
    pub id: u16,
    pub local_id: u8,
    pub nbytes: u8,
    pub oper: u8,
    pub endian: u8, // big, little, dce
    pub base: u8,   // From string or dce
}
...
#[no_mangle]
pub unsafe extern "C" fn rs_bytemath_parse(c_arg: *const c_char) -> *mut DetectByteMathData {
    if c_arg.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn rs_bytemath_free(ptr: *mut DetectByteMathData) {
    if !ptr.is_null() {
