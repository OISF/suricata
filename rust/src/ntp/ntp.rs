...
#[no_mangle]
pub extern "C" fn rs_ntp_state_new(
...
#[no_mangle]
pub unsafe extern "C" fn rs_ntp_parse_request(
...
#[no_mangle]
pub unsafe extern "C" fn rs_ntp_parse_response(
    _flow: *const core::Flow, state: *mut std::os::raw::c_void, _pstate: *mut std::os::raw::c_void,
    stream_slice: StreamSlice, _data: *const std::os::raw::c_void,
) -> AppLayerResult {
    let state = cast_pointer!(state, NTPState);
...
#[no_mangle]
pub unsafe extern "C" fn rs_ntp_state_get_tx(
...
#[no_mangle]
pub unsafe extern "C" fn rs_ntp_state_get_tx_count(state: *mut std::os::raw::c_void) -> u64 {
    let state = cast_pointer!(state, NTPState);
    state.tx_id
}

#[no_mangle]
pub unsafe extern "C" fn rs_ntp_state_tx_free(state: *mut std::os::raw::c_void, tx_id: u64) {
    let state = cast_pointer!(state, NTPState);
    state.free_tx(tx_id);
}
