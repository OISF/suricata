...
pub struct QuicTransaction {
    ...
    pub ja4: Option<(String,String,String)>,
    pub client: bool,
...
impl QuicTransaction {
    fn new(
        ...
        extv: Vec<QuicTlsExtension>, ja3: Option<String>, ja4: Option<(String,String,String)>, client: bool,
    ) -> Self {
...
impl QuicState {
    ...
    fn new_tx(
        ...
        extb: Vec<QuicTlsExtension>, ja3: Option<String>, ja4: Option<(String,String,String)>, client: bool,
    ) {
    ...
    fn handle_frames(&mut self, mut data: QuicData, header: QuicHeader, to_server: bool) {
        let mut sni: Option<Vec<u8>> = None;
        let mut ua: Option<Vec<u8>> = None;
        let mut ja3: Option<String> = None;
        let mut ja4: Option<(String, String, String)> = None;
