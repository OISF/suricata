...
pub type SCHttpRangeFreeBlock = extern fn(c: *mut HttpRangeContainerBlock);
...
pub type SCFileAppendDataById = extern fn(
    file_container: &FileContainer,
    sbcfg: &StreamingBufferConfig,
    track_id: u32,
    data: *const u8,
...
pub type SCFileAppendGAPById = extern fn(
    file_container: &FileContainer,
    sbcfg: &StreamingBufferConfig,
    track_id: u32,
    data: *const u8,
...
pub type SCFileContainerRecycle =
    extern fn(file_container: &FileContainer, sbcfg: &StreamingBufferConfig);
...
#[no_mangle]
pub extern fn rs_init(context: &'static SuricataContext) {
    init_ffi(context);
}
