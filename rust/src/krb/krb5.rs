...
#[no_mangle]
pub extern "C" fn rs_krb5_state_new(
...
#[no_mangle]
pub unsafe extern "C" fn rs_krb5_state_get_tx(
...
#[no_mangle]
pub unsafe extern "C" fn rs_krb5_state_get_tx_count(state: *mut std::os::raw::c_void) -> u64 {
    let state = cast_pointer!(state, KRB5State);
    state.tx_id
}

#[no_mangle]
pub unsafe extern "C" fn rs_krb5_state_tx_free(state: *mut std::os::raw::c_void, tx_id: u64) {
    let state = cast_pointer!(state, KRB5State);
    state.free_tx(tx_id);
}
...
#[no_mangle]
pub unsafe extern "C" fn rs_krb5_probing_parser(
...
#[no_mangle]
pub unsafe extern "C" fn rs_krb5_probing_parser_tcp(
...
#[no_mangle]
pub unsafe extern "C" fn rs_krb5_parse_request(
...
#[no_mangle]
pub unsafe extern "C" fn rs_krb5_parse_response(
    _flow: *const core::Flow, state: *mut std::os::raw::c_void, _pstate: *mut std::os::raw::c_void,
    stream_slice: StreamSlice, _data: *const std::os::raw::c_void,
) -> AppLayerResult {
    let buf = stream_slice.as_slice();
...
#[no_mangle]
pub unsafe extern "C" fn rs_krb5_parse_request_tcp(
    _flow: *const core::Flow, state: *mut std::os::raw::c_void, _pstate: *mut std::os::raw::c_void,
    stream_slice: StreamSlice, _data: *const std::os::raw::c_void,
) -> AppLayerResult {
    let state = cast_pointer!(state, KRB5State);
...
#[no_mangle]
pub unsafe extern "C" fn rs_krb5_parse_response_tcp(
    _flow: *const core::Flow, state: *mut std::os::raw::c_void, _pstate: *mut std::os::raw::c_void,
    stream_slice: StreamSlice, _data: *const std::os::raw::c_void,
) -> AppLayerResult {
    let state = cast_pointer!(state, KRB5State);
