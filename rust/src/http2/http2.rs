...
#[repr(u8)]
#[derive(AppLayerState, Copy, Clone, PartialOrd, PartialEq, Eq, Debug)]
#[suricata(alstate_strip_prefix = "HTTP2ProgWebsocket")]
pub enum HTTP2TxWebsocketProgress {
    HTTP2ProgWebsocketStarted = 0,
    HTTP2ProgWebsocketComplete = 1,
}
...
impl HTTP2Progress {
    fn get(&self, direction: u8) -> i32 {
        match self {
            ...
            HTTP2Progress::WEBSOCKET => HTTP2TxWebsocketProgress::HTTP2ProgWebsocketComplete as i32,
        }
    }
...
// C exports.
#[no_mangle]
pub(crate) unsafe extern "C" fn SCHttp2GetWebsocketTx(
    tx: &HTTP2Transaction,
...
pub unsafe extern "C" fn SCRegisterHttp2Parser() {
    ...
    if SCAppLayerProtoDetectConfProtoDetectionEnabled(ip_proto_str.as_ptr(), parser.name) != 0 {
        ...
        SCAppLayerParserRegisterGetTxSubStateFuncs(
            ...
            Some(HTTP2TxWebsocketProgress::ffi_id_from_name),
            Some(HTTP2TxWebsocketProgress::ffi_name_from_id),
        );
