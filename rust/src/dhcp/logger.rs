...
#[no_mangle]
pub extern fn rs_dhcp_logger_new(conf: *const c_void) -> *mut std::os::raw::c_void {
...
#[no_mangle]
pub unsafe extern fn rs_dhcp_logger_free(logger: *mut std::os::raw::c_void) {
    std::mem::drop(Box::from_raw(logger as *mut DHCPLogger));
}

#[no_mangle]
pub unsafe extern fn rs_dhcp_logger_log(
...
#[no_mangle]
pub unsafe extern fn rs_dhcp_logger_do_log(
