...
pub const SMB1_COMMAND_READ_RAW:                u8 = 0x1a;
pub const SMB1_COMMAND_READ_MPX:                u8 = 0x1b;
pub const SMB1_COMMAND_READ_MPX_SECONDARY:      u8 = 0x1c;
pub const SMB1_COMMAND_WRITE_RAW:               u8 = 0x1d;
pub const SMB1_COMMAND_WRITE_MPX:               u8 = 0x1e;
pub const SMB1_COMMAND_WRITE_MPX_SECONDARY:     u8 = 0x1f;
pub const SMB1_COMMAND_WRITE_COMPLETE:          u8 = 0x20;
pub const SMB1_COMMAND_QUERY_SERVER:            u8 = 0x21;
pub const SMB1_COMMAND_SET_INFORMATION2:        u8 = 0x22;
pub const SMB1_COMMAND_QUERY_INFORMATION2:      u8 = 0x23;
...
pub const SMB1_COMMAND_IOCTL:                   u8 = 0x27;
pub const SMB1_COMMAND_IOCTL_SECONDARY:         u8 = 0x28;
pub const SMB1_COMMAND_COPY:                    u8 = 0x29;
pub const SMB1_COMMAND_MOVE:                    u8 = 0x2a;
...
pub const SMB1_COMMAND_NEW_FILE_SIZE:           u8 = 0x30;
pub const SMB1_COMMAND_CLOSE_AND_TREE_DISC:     u8 = 0x31;
...
pub const SMB1_COMMAND_FIND_NOTIFY_CLOSE:       u8 = 0x35;
pub const SMB1_COMMAND_TREE_CONNECT:            u8 = 0x70;
...
pub const SMB1_COMMAND_SECURITY_PACKAGE_ANDX:   u8 = 0x7e;
pub const SMB1_COMMAND_QUERY_INFO_DISK:         u8 = 0x80;
pub const SMB1_COMMAND_SEARCH:                  u8 = 0x81;
pub const SMB1_COMMAND_FIND:                    u8 = 0x82;
pub const SMB1_COMMAND_FIND_UNIQUE:             u8 = 0x83;
pub const SMB1_COMMAND_FIND_CLOSE:              u8 = 0x84;
...
pub const SMB1_COMMAND_NT_RENAME:               u8 = 0xa5;
pub const SMB1_COMMAND_OPEN_PRINT_FILE:         u8 = 0xc0;
pub const SMB1_COMMAND_WRITE_PRINT_FILE:        u8 = 0xc1;
pub const SMB1_COMMAND_CLOSE_PRINT_FILE:        u8 = 0xc2;
pub const SMB1_COMMAND_GET_PRINT_QUEUE:         u8 = 0xc3;
pub const SMB1_COMMAND_READ_BULK:               u8 = 0xd8;
pub const SMB1_COMMAND_WRITE_BULK:              u8 = 0xd9;
pub const SMB1_COMMAND_WRITE_BULK_DATA:         u8 = 0xda;
pub const SMB1_COMMAND_INVALID:                 u8 = 0xfe;
...
pub fn smb1_command_string(c: u8) -> String {
    match c {
        ...
        SMB1_COMMAND_READ_RAW              => "SMB1_COMMAND_READ_RAW",
        SMB1_COMMAND_READ_MPX              => "SMB1_COMMAND_READ_MPX",
        SMB1_COMMAND_READ_MPX_SECONDARY    => "SMB1_COMMAND_READ_MPX_SECONDARY",
        SMB1_COMMAND_WRITE_RAW             => "SMB1_COMMAND_WRITE_RAW",
        SMB1_COMMAND_WRITE_MPX             => "SMB1_COMMAND_WRITE_MPX",
        SMB1_COMMAND_WRITE_MPX_SECONDARY   => "SMB1_COMMAND_WRITE_MPX_SECONDARY",
        SMB1_COMMAND_WRITE_COMPLETE        => "SMB1_COMMAND_WRITE_COMPLETE",
        SMB1_COMMAND_QUERY_SERVER          => "SMB1_COMMAND_QUERY_SERVER",
        SMB1_COMMAND_SET_INFORMATION2      => "SMB1_COMMAND_SET_INFORMATION2",
        SMB1_COMMAND_QUERY_INFORMATION2    => "SMB1_COMMAND_QUERY_INFORMATION2",
        SMB1_COMMAND_TRANS_SECONDARY       => "SMB1_COMMAND_TRANS_SECONDARY",
        SMB1_COMMAND_IOCTL                 => "SMB1_COMMAND_IOCTL",
        SMB1_COMMAND_IOCTL_SECONDARY       => "SMB1_COMMAND_IOCTL_SECONDARY",
        SMB1_COMMAND_COPY                  => "SMB1_COMMAND_COPY",
        SMB1_COMMAND_MOVE                  => "SMB1_COMMAND_MOVE",
        SMB1_COMMAND_NEW_FILE_SIZE         => "SMB1_COMMAND_NEW_FILE_SIZE",
        SMB1_COMMAND_CLOSE_AND_TREE_DISC   => "SMB1_COMMAND_CLOSE_AND_TREE_DISC",
        SMB1_COMMAND_FIND_NOTIFY_CLOSE     => "SMB1_COMMAND_FIND_NOTIFY_CLOSE",
        SMB1_COMMAND_TREE_CONNECT          => "SMB1_COMMAND_TREE_CONNECT",
        SMB1_COMMAND_SECURITY_PACKAGE_ANDX => "SMB1_COMMAND_SECURITY_PACKAGE_ANDX",
        SMB1_COMMAND_SEARCH                => "SMB1_COMMAND_SEARCH",
        SMB1_COMMAND_FIND                  => "SMB1_COMMAND_FIND",
        SMB1_COMMAND_FIND_UNIQUE           => "SMB1_COMMAND_FIND_UNIQUE",
        SMB1_COMMAND_FIND_CLOSE            => "SMB1_COMMAND_FIND_CLOSE",
        SMB1_COMMAND_NT_TRANS_SECONDARY    => "SMB1_COMMAND_NT_TRANS_SECONDARY",
        SMB1_COMMAND_NT_RENAME             => "SMB1_COMMAND_NT_RENAME",
        SMB1_COMMAND_OPEN_PRINT_FILE       => "SMB1_COMMAND_OPEN_PRINT_FILE",
        SMB1_COMMAND_WRITE_PRINT_FILE      => "SMB1_COMMAND_WRITE_PRINT_FILE",
        SMB1_COMMAND_CLOSE_PRINT_FILE      => "SMB1_COMMAND_CLOSE_PRINT_FILE",
        SMB1_COMMAND_GET_PRINT_QUEUE       => "SMB1_COMMAND_GET_PRINT_QUEUE",
        SMB1_COMMAND_READ_BULK             => "SMB1_COMMAND_READ_BULK",
        SMB1_COMMAND_WRITE_BULK            => "SMB1_COMMAND_WRITE_BULK",
        SMB1_COMMAND_WRITE_BULK_DATA       => "SMB1_COMMAND_WRITE_BULK_DATA",
        SMB1_COMMAND_INVALID               => "SMB1_COMMAND_INVALID",
        SMB1_COMMAND_NONE                  => "SMB1_COMMAND_NONE",
