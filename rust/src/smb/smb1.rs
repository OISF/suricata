...
pub fn smb1_write_request_record<'b>(state: &mut SMBState, r: &SmbRecord<'b>, andx_offset: usize, command: u8, nbss_remaining: u32)
{
    let mut events : Vec<SMBEvent> = Vec::new();
...
pub fn smb1_read_response_record<'b>(state: &mut SMBState, r: &SmbRecord<'b>, andx_offset: usize, nbss_remaining: u32)
{
    let mut events : Vec<SMBEvent> = Vec::new();
