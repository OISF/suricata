...
#[no_mangle]
pub unsafe extern fn rs_smb_version_match(tx: &mut SMBTransaction, version_data: &mut u8) -> u8 {
...
#[no_mangle]
pub unsafe extern fn rs_smb_version_parse(carg: *const c_char) -> *mut c_void {
    if carg.is_null() {
...
#[no_mangle]
pub unsafe extern fn rs_smb_version_free(ptr: *mut c_void) {
