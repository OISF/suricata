...
#[no_mangle]
pub extern "C" fn rs_smb_state_new(
...
#[no_mangle]
pub unsafe extern "C" fn rs_smb_parse_request_tcp(
...
#[no_mangle]
pub unsafe extern "C" fn rs_smb_parse_response_tcp(
    flow: *const Flow, state: *mut ffi::c_void, _pstate: *mut std::os::raw::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn rs_smb_probe_begins_tcp(
...
// return 1 if found, 0 is not found
#[no_mangle]
pub unsafe extern "C" fn rs_smb_probe_tcp(
    _f: *const Flow, flags: u8, input: *const u8, len: u32, rdir: *mut u8,
) -> AppProto {
    if len < MIN_REC_SIZE as u32 {
        return ALPROTO_UNKNOWN;
...
#[no_mangle]
pub unsafe extern "C" fn rs_smb_state_get_tx_count(state: *mut ffi::c_void) -> u64 {
    let state = cast_pointer!(state, SMBState);
...
#[no_mangle]
pub unsafe extern "C" fn rs_smb_state_get_tx(
    state: *mut ffi::c_void, tx_id: u64,
) -> *mut ffi::c_void {
    let state = cast_pointer!(state, SMBState);
...
#[no_mangle]
pub unsafe extern "C" fn rs_smb_state_tx_free(state: *mut ffi::c_void, tx_id: u64) {
    let state = cast_pointer!(state, SMBState);
...
#[no_mangle]
pub unsafe extern "C" fn rs_smb_tx_get_alstate_progress(
    tx: *mut ffi::c_void, direction: u8,
) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn rs_smb_get_tx_data(tx: *mut std::os::raw::c_void) -> *mut AppLayerTxData {
    let tx = cast_pointer!(tx, SMBTransaction);
    return &mut tx.tx_data;
}

#[no_mangle]
pub unsafe extern "C" fn rs_smb_state_truncate(state: *mut std::ffi::c_void, direction: u8) {
    let state = cast_pointer!(state, SMBState);
...
pub unsafe extern "C" fn smb3_probe_tcp(
