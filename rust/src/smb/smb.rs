...
use crate::parser::AppLayerReturn;
...
*/
    ...
    pub fn parse_tcp_data_ts<'b>(&mut self, i: &'b[u8]) -> AppLayerReturn
    {
        let mut cur_i = i;
            ...
            while cur_i.len() > 0 { // min record size
                match search_smb_record(cur_i) {
                    ...
                    _ => {
                        ...
                        return AppLayerReturn::incomplete(consumed as u32, 8);
                    },
                }
            }
        }
                ...
                Err(nom::Err::Incomplete(needed)) => {
                    if let nom::Needed::Size(n) = needed {
                        ...
                        if n >= 512 && cur_i.len() < 512 {
                            ...
                            return AppLayerReturn::incomplete(total_consumed as u32, 512);
                        }
                        ...
                        if consumed == 0 {
                            ...
                            return AppLayerReturn::incomplete(total_consumed as u32, need as u32);
                        }
    ...
    /// Parsing function, handling TCP chunks fragmentation
    pub fn parse_tcp_data_tc<'b>(&mut self, i: &'b[u8]) -> AppLayerReturn
    {
        let mut cur_i = i;
