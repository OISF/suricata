...
pub enum DetectBase64Mode {
     ...
     * */
    ModeRFC2045, /* SPs are allowed during transfer but must be skipped by Decoder */
    ModeStrict,
     ...
     * encountered
     * */
    ModeRFC4648, /* reject the encoded data if it contains characters outside the base alphabet */
}
