...
mod tests {
    ...
    fn valid_test(
        ...
        result: &str, base: u8, endian: ByteMathEndian, bitmask_val: u32, flags: u8,
    ) {
    ...
    fn test_parser_multiple() {
        assert_eq!(true, parse_bytemath("bytes 4, bytes 4, offset 0, oper +, rvalue myrvalue, result myresult, endian big").is_err());
        assert_eq!(true, parse_bytemath("bytes 4, offset 0, offset 0, oper +, rvalue myrvalue, result myresult, endian big").is_err());
        assert_eq!(true, parse_bytemath("bytes 4, offset 0, oper +, oper +, rvalue myrvalue, result myresult, endian big").is_err());
