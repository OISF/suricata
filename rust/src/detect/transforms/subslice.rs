    ...
    match parts.as_slice() {
        ...
        [first, second] => {
            ...
            if second.eq_ignore_ascii_case("truncate") {
                ...
                if nbytes == 0 {
                    SCLogError!("Invalid subslice options; nbytes value cannot be 0");
                    return None;
                }
                Some(DetectTransformSubsliceData {
                    offset,
        ...
        [first, second, third] => {
            ...
            if !third.eq_ignore_ascii_case("truncate") {
                SCLogError!("Invalid subslice options; {} not recognized", third);
                return None;
            }
...
unsafe extern "C" fn subslice_id(data: *mut *const u8, length: *mut u32, ctx: *const c_void) {
