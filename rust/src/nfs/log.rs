...
#[no_mangle]
pub extern fn rs_nfs_tx_logging_is_filtered(state: &mut NFSState, tx: &mut NFSTransaction) -> u8 {
...
#[no_mangle]
pub extern fn rs_nfs_log_json_request(
    state: &mut NFSState, tx: &mut NFSTransaction, js: &mut JsonBuilder,
) -> bool {
...
#[no_mangle]
pub extern fn rs_nfs_log_json_response(
    state: &mut NFSState, tx: &mut NFSTransaction, js: &mut JsonBuilder,
) -> bool {
...
#[no_mangle]
pub extern fn rs_rpc_log_json_response(tx: &mut NFSTransaction, js: &mut JsonBuilder) -> bool {
