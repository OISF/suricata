...
named!(
    ...
    do_parse!(
        _client_id: take!(8) >> _verifier: take!(8) >> (Nfs4RequestContent::SetClientIdConfirm)
    )
);
...
named!(
    ...
    do_parse!(attrs: nfs4_parse_attrs >> (Nfs4OpenRequestContent::Unchecked4(attrs)))
);

named!(
    nfs4_req_open_guarded4<Nfs4OpenRequestContent>,
    do_parse!(attrs: nfs4_parse_attrs >> (Nfs4OpenRequestContent::Guarded4(attrs)))
);
...
named!(
    ...
    do_parse!(
        oldname: nfs4_parse_nfsstring
            ...
            >> (Nfs4RequestContent::Rename(Nfs4RequestRename { oldname, newname }))
    )
);
...
named!(
    ...
    do_parse!(filename: nfs4_parse_nfsstring >> (Nfs4RequestContent::Remove(filename)))
);
...
named!(
    ...
    do_parse!(
        stateid: nfs4_parse_stateid
            >> _attrs: nfs4_parse_attrs
            >> (Nfs4RequestContent::SetAttr(Nfs4RequestSetAttr { stateid }))
    )
);

named!(
    nfs4_req_getattr<Nfs4RequestContent>,
    do_parse!(attrs: nfs4_parse_attrbits >> (Nfs4RequestContent::GetAttr(attrs)))
);
...
named!(
    ...
    do_parse!(
        _seqid: be_u32 >> stateid: nfs4_parse_stateid >> (Nfs4RequestContent::Close(stateid))
    )
);
...
named!(
    ...
    do_parse!(
        stateid: nfs4_parse_stateid
            >> _seqid: be_u32
            >> (Nfs4RequestContent::OpenConfirm(Nfs4RequestOpenConfirm { stateid }))
    )
);
...
named!(
    ...
    do_parse!(
        ssn_id: take!(16)
            ...
            >> _cache_this: be_u32
            >> (Nfs4RequestContent::Sequence(Nfs4RequestSequence { ssn_id }))
    )
);
...
named!(
    ...
    do_parse!(
        count: be_u32
            >> committed: be_u32
            >> _verifier: be_u64
            >> (Nfs4ResponseWrite { count, committed })
    )
);
...
named!(
    ...
    do_parse!(
        stateid: nfs4_parse_stateid
            ...
            >> who_len: be_u32
            >> _who: take!(who_len)
            >> (Nfs4ResponseOpenDelegateRead { stateid })
    )
);
...
named!(
    ...
    do_parse!(status: be_u32 >> (Nfs4ResponseContent::SetClientIdConfirm(status)))
);
