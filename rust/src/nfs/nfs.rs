...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_gettxfiles(
...
#[no_mangle]
pub extern "C" fn rs_nfs_state_new(
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_parse_request(
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_parse_response(
    flow: *const Flow, state: *mut std::os::raw::c_void, _pstate: *mut std::os::raw::c_void,
    stream_slice: StreamSlice, _data: *const std::os::raw::c_void,
) -> AppLayerResult {
    let state = cast_pointer!(state, NFSState);
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_parse_request_udp(
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_parse_response_udp(
    f: *const Flow, state: *mut std::os::raw::c_void, _pstate: *mut std::os::raw::c_void,
    stream_slice: StreamSlice, _data: *const std::os::raw::c_void,
) -> AppLayerResult {
    let state = cast_pointer!(state, NFSState);
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_state_get_tx_count(state: *mut std::os::raw::c_void) -> u64 {
    let state = cast_pointer!(state, NFSState);
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_state_get_tx(
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_state_tx_free(state: *mut std::os::raw::c_void, tx_id: u64) {
    let state = cast_pointer!(state, NFSState);
    state.free_tx(tx_id);
}

#[no_mangle]
pub unsafe extern "C" fn rs_nfs_tx_get_alstate_progress(
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_get_tx_data(tx: *mut std::os::raw::c_void) -> *mut AppLayerTxData {
    let tx = cast_pointer!(tx, NFSTransaction);
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_tx_get_procedures(
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_tx_get_version(tx: &mut NFSTransaction, version: *mut u32) {
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_probe(
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_probe_udp_ts(
...
#[no_mangle]
pub unsafe extern "C" fn rs_nfs_probe_udp_tc(
    _f: *const Flow, _direction: u8, input: *const u8, len: u32, _rdir: *mut u8,
) -> AppProto {
    let slice: &[u8] = build_slice!(input, len as usize);
