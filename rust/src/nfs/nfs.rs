...
#[no_mangle]
pub unsafe extern fn rs_nfs_gettxfiles(
...
impl NFSState {
    ...
    fn add_rpc_udp_tc_frames(
        ...
        if rpc_len > 8 {
            let _rpc_udp_tc_hdr =
                Frame::new(flow, stream_slice, input, 8, NFSFrameType::RPCHdr as u8);
    ...
    fn add_rpc_tcp_tc_frames(
        ...
        if rpc_tcp_len > 12 {
            let _rpc_tcp_tc_hdr =
                Frame::new(flow, stream_slice, input, 12, NFSFrameType::RPCHdr as u8);
    ...
    fn add_nfs_tc_frames(
        ...
        if nfs_len > 0 {
            ...
            let _nfs_res_status =
                Frame::new(flow, stream_slice, input, 4, NFSFrameType::NFSStatus as u8);
    ...
    fn add_nfs4_tc_frames(
        ...
        if nfs4_len > 0 {
            ...
            let _nfs4_tc_status =
                Frame::new(flow, stream_slice, input, 4, NFSFrameType::NFS4Status as u8);
