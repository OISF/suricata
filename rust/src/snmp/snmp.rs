...
#[no_mangle]
pub extern "C" fn rs_snmp_state_new(
...
#[no_mangle]
pub unsafe extern "C" fn rs_snmp_parse_request(
    ...
    state
        .parse(stream_slice.as_slice(), Direction::ToServer)
        .into()
}

#[no_mangle]
pub unsafe extern "C" fn rs_snmp_parse_response(
    _flow: *const core::Flow, state: *mut std::os::raw::c_void, _pstate: *mut std::os::raw::c_void,
    stream_slice: StreamSlice, _data: *const std::os::raw::c_void,
) -> AppLayerResult {
    let state = cast_pointer!(state, SNMPState);
    state
        .parse(stream_slice.as_slice(), Direction::ToClient)
        .into()
}

#[no_mangle]
pub unsafe extern "C" fn rs_snmp_state_get_tx(
...
#[no_mangle]
pub unsafe extern "C" fn rs_snmp_state_get_tx_count(state: *mut std::os::raw::c_void) -> u64 {
    let state = cast_pointer!(state, SNMPState);
    state.tx_id
}

#[no_mangle]
pub unsafe extern "C" fn rs_snmp_state_tx_free(state: *mut std::os::raw::c_void, tx_id: u64) {
    let state = cast_pointer!(state, SNMPState);
    state.free_tx(tx_id);
}

#[no_mangle]
pub extern "C" fn rs_snmp_tx_get_alstate_progress(
...
#[no_mangle]
pub unsafe extern "C" fn rs_snmp_probing_parser(
