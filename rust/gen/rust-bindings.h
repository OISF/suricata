...
uint8_t rs_dns_probe_tcp(uint8_t direction,
                         const uint8_t *input,
                         uint32_t len,
                         uint8_t *rdir);
...
int32_t rs_rdp_parse_tc(const Flow *_flow,
                        void *state,
                        void *_pstate,
                        const uint8_t *input,
                        uint32_t input_len,
...
int32_t rs_rdp_parse_ts(const Flow *_flow,
                        void *state,
                        void *_pstate,
                        const uint8_t *input,
                        uint32_t input_len,
...
int32_t rs_sip_parse_request(const Flow *_flow,
                             void *state,
                             void *_pstate,
                             const uint8_t *input,
                             uint32_t input_len,
...
int32_t rs_sip_parse_response(const Flow *_flow,
                              void *state,
                              void *_pstate,
                              const uint8_t *input,
                              uint32_t input_len,
