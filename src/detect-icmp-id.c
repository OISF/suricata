...
void DetectIcmpIdRegister (void) {
    ...
    sigmatch_table[DETECT_ICMP_SEQ].desc = "check for a ICMP id";
    sigmatch_table[DETECT_ICMP_SEQ].url = "https://redmine.openinfosecfoundation.org/projects/suricata/wiki/Header_keywords#icmp_id";
