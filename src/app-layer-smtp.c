...
static AppLayerReturn SMTPParse(int direction, Flow *f, SMTPState *state,
...
static AppLayerReturn SMTPParseClientRecord(Flow *f, void *alstate,
                                 AppLayerParserState *pstate,
...
static AppLayerReturn SMTPParseServerRecord(Flow *f, void *alstate,
                                 AppLayerParserState *pstate,
                                 const uint8_t *input, uint32_t input_len,
                                 void *local_data, const uint8_t flags)
{
