...
/**
 *   [ikev1.nonce_payload_length]:[=|<|>|<=|>=]<length>;
 */
...
static int DetectEngineInspectIkeNoncePayloadLengthGeneric(ThreadVars *tv,
                                                   DetectEngineCtx *de_ctx, DetectEngineThreadCtx *det_ctx,
                                                   const Signature *s, const SigMatchData *smd,
                                                   Flow *f, uint8_t flags, void *alstate,
                                                   void *txv, uint64_t tx_id);

static int DetectIkeNoncePayloadLengthMatch (DetectEngineThreadCtx *, Flow *,
...
{
    sigmatch_table[DETECT_AL_IKE_NONCE_PAYLOAD_LENGTH].name = "ikev1.nonce_payload_length";
    sigmatch_table[DETECT_AL_IKE_NONCE_PAYLOAD_LENGTH].desc = "match IKEv1 nonce payload length";
    sigmatch_table[DETECT_AL_IKE_NONCE_PAYLOAD_LENGTH].url = "/rules/ike-keywords.html#ike-nonce-payload-length";
    sigmatch_table[DETECT_AL_IKE_NONCE_PAYLOAD_LENGTH].AppLayerTxMatch = DetectIkeNoncePayloadLengthMatch;
    ...
    DetectAppLayerInspectEngineRegister("ikev1.nonce_payload_length",
                                        ...
                                        DetectEngineInspectIkeNoncePayloadLengthGeneric);

    DetectAppLayerInspectEngineRegister("ikev1.nonce_payload_length",
                                        ALPROTO_IKE, SIG_FLAG_TOCLIENT, 1,
                                        DetectEngineInspectIkeNoncePayloadLengthGeneric);

    g_ike_nonce_payload_length_buffer_id = DetectBufferTypeGetByName("ikev1.nonce_payload_length");
 ...
 * \retval 1 match.
 */
static int DetectIkeNoncePayloadLengthMatch (DetectEngineThreadCtx *det_ctx,
 ...
 * \retval -1 on Failure.
 */
static int DetectIkeNoncePayloadLengthSetup (DetectEngineCtx *de_ctx, Signature *s, const char *rawstr)
{
