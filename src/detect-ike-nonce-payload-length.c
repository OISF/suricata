...
static int DetectEngineInspectIkeNoncePayloadLengthGeneric(ThreadVars *tv, DetectEngineCtx *de_ctx,
...
void DetectIkeNoncePayloadLengthRegister(void)
{
    ...
    DetectAppLayerInspectEngineRegister("ikev1.nonce_payload_length", ALPROTO_IKE,
            SIG_FLAG_TOSERVER, 1, DetectEngineInspectIkeNoncePayloadLengthGeneric);

    DetectAppLayerInspectEngineRegister("ikev1.nonce_payload_length", ALPROTO_IKE,
            SIG_FLAG_TOCLIENT, 1, DetectEngineInspectIkeNoncePayloadLengthGeneric);
