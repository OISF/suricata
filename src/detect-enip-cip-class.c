...
{
    return rs_enip_tx_has_cip_class(txv, ctx);
}
...
void DetectEnipCipClassRegister(void)
{
    ...
    DetectAppLayerInspectEngineRegister2("enip.cip_class", ALPROTO_ENIP, SIG_FLAG_TOSERVER, 0,
            DetectEngineInspectGenericList, NULL);
    DetectAppLayerInspectEngineRegister2("enip.cip_class", ALPROTO_ENIP, SIG_FLAG_TOCLIENT, 0,
            DetectEngineInspectGenericList, NULL);
