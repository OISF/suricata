 ...
 */
static ThreadLogFileHashEntry *LogFileThread2Slot(LogThreadedFileCtx *parent, int thread_id)
{
    ...
    if (!ent) {
        ...
        ent->internal_thread_id = (uint32_t)thread_id;
        SCLogDebug(
 ...
 */
LogFileCtx *LogFileEnsureExists(int thread_id, LogFileCtx *parent_ctx)
{
