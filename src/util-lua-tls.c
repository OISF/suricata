...
static const struct luaL_Reg tlslib_meta[] = { { "get_server_cert_not_before",
                                                       LuaTlsGetServerCertNotBefore },
    ...
    { "get_client_cert_info", LuaTlsGetClientCertInfo }, { "get_client_sni", LuaTlsGetSNI },
