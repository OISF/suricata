...
{
    return al_proto_table[alproto].StateGetAlstateProgressDoneValue(direction);
}
...
{
    al_proto_table[alproto].StateGetAlstateProgressDoneValue = StateGetAlstateProgressDoneValue;
}
...
void AppLayerTransactionUpdateInspectId(Flow *f, uint8_t flags)
{
    ...
    int state_done_progress = AppLayerGetAlstateProgressDoneValue(f->alproto, direction);
    void *tx;
    int tx_updated_by = 0;
    int state_progress;
