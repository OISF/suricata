...
static inline void SCRadixValidateIPv4Key(uint8_t *key, const uint8_t netmask)
{
    uint32_t address;
...
static inline void SCRadixValidateIPv6Key(uint8_t *key, const uint8_t netmask)
{
    uint32_t address[4];
    memcpy(&address, key, sizeof(address));
