...
#define MAX_SUBSTRINGS 30
    ...
    /* We need to check whether the input is numeric like this because
       StringParseUint8() will silently parse numeric prefixes from
       mixed alphanumeric input, which we don't want here */
