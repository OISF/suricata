...
void TmModuleJsonDnsLogRegister (void)
{
    ...
    OutputRegisterTxModuleWithProgress(MODULE_NAME, "dns-json-log",
        JsonDnsLogInitCtx, ALPROTO_DNS, JsonDnsLoggerToServer, 1, 1);

    /* Logger for replies. */
    OutputRegisterTxModuleWithProgress(MODULE_NAME, "dns-json-log",
        JsonDnsLogInitCtx, ALPROTO_DNS, JsonDnsLoggerToClient, 2, 1);

    /* Sub-logger for requests. */
    OutputRegisterTxSubModuleWithProgress("eve-log", MODULE_NAME, "eve-log.dns",
        JsonDnsLogInitCtxSub, ALPROTO_DNS, JsonDnsLoggerToServer, 1, 1);

    /* Sub-logger for replies. */
    OutputRegisterTxSubModuleWithProgress("eve-log", MODULE_NAME, "eve-log.dns",
        JsonDnsLogInitCtxSub, ALPROTO_DNS, JsonDnsLoggerToClient, 2, 1);
}
