...
void SupportFastPatternForSigMatchTypes(void)
{
    ...
    SupportFastPatternForSigMatchList(DETECT_SM_LIST_DNP3_DATA_MATCH, 2);
...
#define MAX_SUBSTRINGS 30
    ...
    if (s->sm_lists_tail[DETECT_SM_LIST_PMATCH] == NULL &&
        ...
        s->sm_lists_tail[DETECT_SM_LIST_DNP3_DATA_MATCH] == NULL) {
    ...
    SigMatch *pm = SigMatchGetLastSMFromLists(s, 28,
            ...
            DETECT_CONTENT, s->sm_lists_tail[DETECT_SM_LIST_DNP3_DATA_MATCH]);
    if (pm == NULL) {
