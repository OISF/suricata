...
enum {
    HOST_IS_SNIFFER_ONLY,
    HOST_IS_ROUTER,
};

#define IS_HOST_MODE_SNIFFER_ONLY(host_mode)  ((host_mode) == HOST_IS_SNIFFER_ONLY)
#define IS_HOST_MODE_ROUTER(host_mode)  ((host_mode) == HOST_IS_ROUTER)
