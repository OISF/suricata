...
static int DetectEngineHttpStatCodeTest16(void)
 {
    TcpSession ssn;
    Packet *p1 = NULL;
    Packet *p2 = NULL;
...
void DetectEngineHttpStatCodeRegisterTests(void)
{
    ...
    UtRegisterTest("DetectEngineHttpStatCodeTest16",
                   DetectEngineHttpStatCodeTest16, 1);
#endif /* UNITTESTS */
