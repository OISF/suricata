...
/**
 * \test Test that dce_iface match for many requests.
 */
static int DetectDceIfaceInManyPacketsTest(void)
{
    int result = 0;
    Signature *s = NULL;
    ThreadVars th_v;
    ...
    uint8_t dcerpc_bindack[] = {
        ...
        0xd0, 0x16, 0xd0, 0x16, 0x34, 0x0f, 0x00, 0x00,
        0x06, 0x00, 0x34, 0x39, 0x36, 0x37, 0x32, 0x00,
    ...
    uint8_t dcerpc_req1[] = {
        ...
        0x6a, 0x00, 0x00, 0x00, 0x01, 0x00, 0x04, 0x00,
        0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x64, 0x00, 0x63, 0x00, 0x30, 0x00, 0x31, 0x00,
        0x2e, 0x00, 0x63, 0x00, 0x79, 0x00, 0x6c, 0x00,
        0x65, 0x00, 0x72, 0x00, 0x61, 0x00, 0x2e, 0x00,
        0x6c, 0x00, 0x61, 0x00, 0x62, 0x00, 0x00, 0x00,
    ...
    uint8_t dcerpc_resp1[] = {
        0x05, 0x00, 0x02, 0x03, 0x10, 0x00, 0x00, 0x00,
        0x24, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
        0x0c, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
        0xac, 0x38, 0x04, 0xc3, 0xe4, 0x1d, 0xd3, 0x7f,
        0x00, 0x00, 0x00, 0x00
    };
    ...
    uint8_t dcerpc_req2[] = {
        ...
        0x98, 0x00, 0x00, 0x00, 0x01, 0x00, 0x0f, 0x00,
        0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        0x64, 0x00, 0x63, 0x00, 0x30, 0x00, 0x31, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0x2f, 0x21
    };
    ...
    s = DetectEngineAppendSig(de_ctx, "alert dcerpc any any -> any any "
                                      "(msg:\"DCERPC Netlogon\"; "
    ...
    if (!PacketAlertCheck(p, 1)) {
        SCLogDebug("sig 1 not matched in req2");
        goto end;
    }
...
static void DetectDceIfaceRegisterTests(void)
{
    ...
    UtRegisterTest("DetectDceIfaceInManyPacketsTest", DetectDceIfaceInManyPacketsTest);
}
#endif /* UNITTESTS */
