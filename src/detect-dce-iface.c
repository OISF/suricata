...
/**
 * \test Test that SMB dce_iface match for many requests.
 */
static int DetectSmbDceIfaceInManyPacketsTest(void)
{
    int result = 0;
    Signature *s = NULL;
    ThreadVars th_v;
    ...
    uint8_t smb_dcerpc_bind[] = {
        0x00, 0x00, 0x00, 0xb8, 0xfe, 0x53, 0x4d, 0x42,
        ...
        0x00, 0xfc, 0x00, 0x00, 0xb4, 0x91, 0x9a, 0x52,
        0xc2, 0xc2, 0x7e, 0xa5, 0x0b, 0xe6, 0x3e, 0x40,
        0x83, 0x92, 0x14, 0x7b, 0x31, 0x00, 0x70, 0x00,
        0x48, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x8b, 0x00, 0x00, 0x00,
        0x3f, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x3f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x0b, 0x03,
        0x10, 0x00, 0x00, 0x00, 0x48, 0x00, 0x00, 0x00,
        0x01, 0x00, 0x00, 0x00, 0xb8, 0x10, 0xb8, 0x10,
    ...
    uint8_t smb_write_response[] = {
        0x00, 0x00, 0x00, 0x50, 0xfe, 0x53, 0x4d, 0x42,
        0x40, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x09, 0x00, 0x7f, 0x00, 0x09, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x01, 0x00, 0x00, 0x00, 0x61, 0x00, 0x00, 0x0c,
        0x00, 0xfc, 0x00, 0x00, 0x59, 0x78, 0xce, 0x05,
        0x89, 0xf0, 0x10, 0x5b, 0xcd, 0x1e, 0x5c, 0xa2,
        0x95, 0x39, 0xca, 0x1e, 0x11, 0x00, 0x00, 0x00,
        0x48, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00
    };

    uint8_t smb_read_request[] = {
        0x00, 0x00, 0x00, 0x71, 0xfe, 0x53, 0x4d, 0x42,
        0x40, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x08, 0x00, 0x7f, 0x00, 0x08, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x01, 0x00, 0x00, 0x00, 0x61, 0x00, 0x00, 0x0c,
        0x00, 0xfc, 0x00, 0x00, 0xaa, 0x08, 0x86, 0x7d,
        0x41, 0xa2, 0xdb, 0x10, 0x57, 0x7f, 0x86, 0x77,
        0x68, 0xb7, 0xf1, 0xb9, 0x31, 0x00, 0x50, 0x00,
    ...
    uint8_t smb_dcerpc_bindack[] = {
        
    };
    ...
    r = AppLayerParserParse(NULL, alp_tctx, &f, ALPROTO_SMB,
                            STREAM_TOSERVER | STREAM_START, smb_dcerpc_bind,
                            sizeof(smb_dcerpc_bind));
    if (r != 0) {
        SCLogDebug("AppLayerParse for dcerpc failed.  Returned %" PRId32, r);
        FLOWLOCK_UNLOCK(&f);
        goto end;
    ...
    FLOWLOCK_WRLOCK(&f);
    r = AppLayerParserParse(NULL, alp_tctx, &f, ALPROTO_SMB,
                            STREAM_TOCLIENT, smb_write_response,
                            sizeof(smb_write_response));
    if (r != 0) {
        SCLogDebug("AppLayerParse for dcerpc failed.  Returned %" PRId32, r);
        FLOWLOCK_UNLOCK(&f);
        goto end;
    ...
    FLOWLOCK_WRLOCK(&f);
    r = AppLayerParserParse(NULL, alp_tctx, &f, ALPROTO_SMB,
                            STREAM_TOSERVER, smb_read_request,
                            sizeof(smb_read_request));
    if (r != 0) {
        SCLogDebug("AppLayerParse for dcerpc failed.  Returned %" PRId32, r);
        FLOWLOCK_UNLOCK(&f);
        goto end;
    ...
    FLOWLOCK_WRLOCK(&f);
    r = AppLayerParserParse(NULL, alp_tctx, &f, ALPROTO_SMB,
                            STREAM_TOCLIENT, smb_dcerpc_bindack,
                            sizeof(smb_dcerpc_bindack));
    if (r != 0) {
        SCLogDebug("AppLayerParse for dcerpc failed.  Returned %" PRId32, r);
        FLOWLOCK_UNLOCK(&f);
        goto end;
    ...
    SigMatchSignatures(&th_v, de_ctx, det_ctx, p);
    if (PacketAlertCheck(p, 1)) {
        SCLogDebug("sig 1 not matched but shouldn't have: ");
        goto end;
    }

    FLOWLOCK_WRLOCK(&f);
    r = AppLayerParserParse(NULL, alp_tctx, &f, ALPROTO_SMB,
                            STREAM_TOSERVER, smb_dcerpc_req1,
...
static void DetectDceIfaceRegisterTests(void)
{
    ...
    UtRegisterTest("DetectSmbDceIfaceInManyPacketsTest",
                   DetectSmbDceIfaceInManyPacketsTest);
}
#endif /* UNITTESTS */
