...
static AppLayerLogger alert_applayer_loggers[ALPROTO_MAX] = {
    ...
    { ALPROTO_MODBUS, (SimpleTxLogFunc)rs_modbus_to_json },
    ...
    { ALPROTO_SNMP, (SimpleTxLogFunc)rs_snmp_log_json_response },
    { ALPROTO_SIP, (SimpleTxLogFunc)rs_sip_log_json },
    ...
    { ALPROTO_RDP, (SimpleTxLogFunc)rs_rdp_to_json },
