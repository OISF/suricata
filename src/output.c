...
void OutputRegisterRootLoggers(void)
{
    ...
    RegisterSimpleJsonApplayerLogger(ALPROTO_POP3, rs_pop3_logger_log, NULL);
...
void OutputRegisterLoggers(void)
{
    ...
    JsonDoh2LogRegister();
    /* POP3 JSON logger. */
    OutputRegisterTxSubModule(LOGGER_JSON_TX, "eve-log", "JsonPOP3Log", "eve-log.template",
            OutputJsonLogInitSub, ALPROTO_POP3, JsonGenericDirPacketLogger, JsonLogThreadInit,
            JsonLogThreadDeinit);
