 ...
 * configured \param filter ClasstypeFilter to check (can be NULL) \param pa PacketAlert containing
 * the signature \return true if payload should be extracted, false otherwise
 */
