...
void DetectBytetestRegister (void)
{
    ...
    sigmatch_table[DETECT_BYTETEST].desc = "extracts <num of bytes> and performs an operation selected with <operator> against the value in <test value> at a particular <offset>";
