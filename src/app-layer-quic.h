...
typedef struct quicTransaction_ {
    ...
    TAILQ_ENTRY(quicTransaction_) next;

} quicTransaction;

typedef struct quicState_ {

    TAILQ_HEAD(, quicTransaction_) tx_list; /**< List of quic transactions
