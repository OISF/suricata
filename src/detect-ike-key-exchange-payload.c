...
#define KEYWORD_NAME_KEY_EXCHANGE "ikev1.key_exchange_payload"
#define KEYWORD_DOC_KEY_EXCHANGE  "ike-keywords.html#ike-key_exchange_payload";
#define BUFFER_NAME_KEY_EXCHANGE  "ikev1.key_exchange_payload"
#define BUFFER_DESC_KEY_EXCHANGE  "ikev1 key_exchange payload"
...
void DetectIkeKeyExchangeRegister(void)
{
    ...
    sigmatch_table[DETECT_AL_IKE_KEY_EXCHANGE].url = "/rules/" KEYWORD_DOC_KEY_EXCHANGE
    sigmatch_table[DETECT_AL_IKE_KEY_EXCHANGE].desc = "sticky buffer to match on the IKEv1 key_exchange_payload";
    sigmatch_table[DETECT_AL_IKE_KEY_EXCHANGE].Setup = DetectKeyExchangeSetup;
    sigmatch_table[DETECT_AL_IKE_KEY_EXCHANGE].flags |= SIGMATCH_NOOPT|SIGMATCH_INFO_STICKY_BUFFER;

    DetectAppLayerInspectEngineRegister2(BUFFER_NAME_KEY_EXCHANGE, ALPROTO_IKE,
            SIG_FLAG_TOSERVER, 1,
    ...
    DetectAppLayerMpmRegister2(BUFFER_NAME_KEY_EXCHANGE, SIG_FLAG_TOSERVER, 1,
            PrefilterGenericMpmRegister, GetKeyExchangeData, ALPROTO_IKE,
            1);
