...
static int SCSigOrderingTest07(void)
{
    ...
    sig = DetectEngineAppendSig(
            de_ctx, "alert tcp any !21:902 -> any any (msg:\"Testing sigordering alert\"; "
                    "content:\"220\"; offset:0; depth:4; pcre:\"/220[- ]/\"; sid:1; rev:4;)");
    FAIL_IF_NULL(sig);

    sig = DetectEngineAppendSig(
            de_ctx, "pass tcp any !21:902 -> any any (msg:\"Testing sigordering pass\"; "
...
static int SCSigOrderingTest08(void)
{
    ...
    sig = DetectEngineAppendSig(
            de_ctx, "pass tcp any !21:902 -> any any (msg:\"Testing sigordering reject\"; "
...
static int SCSigOrderingTest11(void)
{
    ...
    sig = DetectEngineAppendSig(
            de_ctx, "alert tcp any !21:902 -> any any (msg:\"Testing sigordering set\"; "
                    "flowbits:isnotset,myflow1; rev:4; sid:1;)");
    FAIL_IF_NULL(sig);

    sig = DetectEngineAppendSig(
            de_ctx, "alert tcp any !21:902 -> any any (msg:\"Testing sigordering toggle\"; "
                    "flowbits:toggle,myflow2; rev:4; sid:2;)");
    FAIL_IF_NULL(sig);

    sig = DetectEngineAppendSig(
            de_ctx, "alert tcp any !21:902 -> any any (msg:\"Testing sigordering unset\"; "
