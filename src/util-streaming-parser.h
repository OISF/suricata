 ...
 *
 * Note: All combinations of Test and Get would except where you first try
 * to retrieve a value using Test() and the api demands more data(RDATA),
 * and the next time you call Test() or Get() function with a byte-order
 * different from the first call.  What'll you see in this case
 * would be junk.
 */
