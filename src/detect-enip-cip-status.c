...
void DetectEnipCipStatusRegister(void)
{
    ...
    DetectAppLayerInspectEngineRegister2("enip.cip_status", ALPROTO_ENIP, SIG_FLAG_TOSERVER, 0,
            DetectEngineInspectGenericList, NULL);
    DetectAppLayerInspectEngineRegister2("enip.cip_status", ALPROTO_ENIP, SIG_FLAG_TOCLIENT, 0,
            DetectEngineInspectGenericList, NULL);
