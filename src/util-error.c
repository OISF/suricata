...
const char * SCErrorToString(SCError err)
{
    switch (err) {
        ...
        CASE_CODE (SC_ERR_DPDKINTEL_CONFIG_FAILED);
        CASE_CODE (SC_ERR_DPDKINTEL_MEM_FAILED);
        CASE_CODE (SC_ERR_DPDKINTEL_RECEIVE_REGISTER_FAILED);
        CASE_CODE (SC_ERR_DPDKINTEL_DECODE_REGISTER_FAILED);
        CASE_CODE (SC_ERR_DPDKINTEL_DPDKAPI);
        CASE_CODE (SC_ERR_DPDKINTEL_SCAPI);
#endif
    }
