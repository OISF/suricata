...
#define LOG_TLS_FIELD_SUBJECT_PK_ALGO       (1 << 11)
#define LOG_TLS_FIELD_CERT_SIGNATURE_ALGO   (1 << 12)
#define LOG_TLS_FIELD_SIGNATURE_ALGO        (1 << 13)
#define LOG_TLS_FIELD_EXTENSIONS            (1 << 14)
