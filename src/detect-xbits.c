...
static int XBitsTestSig05(void)
{
    ...
    Signature *s = DetectEngineAppendSig(de_ctx,
            ...
            "xbits:set,ET.2020_8260.1,track ip_src,expire 10,noalert; "
            "reference:url,packetstormsecurity.com/files/160619/"
            "Pulse-Secure-VPN-Remote-Code-Execution.html; reference:cve,2020-8260; "
            "classtype:attempted-admin; sid:2033750; rev:1; metadata:attack_target Server, "
            "created_at 2021_08_20, cve CVE_2020_8260, deployment Perimeter, deployment "
            "Internal, former_category EXPLOIT, signature_severity Major, tag Exploit, "
            "updated_at 2021_08_20;)");
    FAIL_IF_NULL(s);
...
static int XBitsTestSig06(void)
{
    ...
    Signature *s = DetectEngineAppendSig(de_ctx,
            ...
            "content:\"/dana-admin/cached/config/import.cgi\"; http.referer; "
            "content:\"/dana-admin/cached/config/config.cgi?type=system\"; fast_pattern; "
            "xbits:isset,ET.2020_8260.1,track ip_src,expire 10,noalert; "
            "xbits:set,ET.2020_8260.2,track ip_src,expire 10; "
            "reference:url,packetstormsecurity.com/files/160619/"
            "Pulse-Secure-VPN-Remote-Code-Execution.html; reference:cve,2020-8260; "
            "classtype:attempted-admin; sid:2033751; rev:1; metadata:attack_target Server, "
            "created_at 2021_08_20, cve CVE_2020_8260, deployment Perimeter, deployment "
            "Internal, former_category EXPLOIT, signature_severity Major, tag Exploit, "
            "updated_at 2021_08_20;)");
    FAIL_IF_NULL(s);
...
static int DetectXBitsTestGoodRules(void)
{
    ...
    const char *sigs[] = {
        ...
        "alert http any any -> any any (content:\"abc\"; xbits:isnotset,bit3,track ip_pair;sid:3;)",
        "alert http any any -> any any (content:\"abc\"; xbits:toggle,bit4,track ip_pair;sid:4;)",
        ...
        "10;sid:6;)",
        "alert http any any -> any any (content:\"abc\"; xbits:set,bit7,track ip_pair,expire 3600, "
        "noalert;sid:7;)",
        NULL,
    };
