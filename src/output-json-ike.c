...
static int JsonIKELogger(ThreadVars *tv, void *thread_data,
...
static OutputInitResult OutputIKELogInitSub(ConfNode *conf,
...
void JsonIKELogRegister(void)
{
    ...
    OutputRegisterTxSubModule(LOGGER_JSON_IKE, "eve-log",
        "JsonIKELog", "eve-log.ike",
        OutputIKELogInitSub, ALPROTO_IKE, JsonIKELogger,
        JsonIKELogThreadInit, JsonIKELogThreadDeinit, NULL);
}
