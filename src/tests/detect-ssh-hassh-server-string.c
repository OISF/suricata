 ...
 */
static int DetectSshHasshServerStringTest01(void) {
    Flow f;
    ...
    uint8_t sshbuf3[] = {0x00, 0x00, 0x04, 0x34, 0x06, 0x14, 0x7d, 0x76, 0x4f, 0x78, 0x81, 0x9e, 0x10, 0xfa, 0x23, 0x72,
    ...
    s = de_ctx->sig_list = SigInit(de_ctx, "alert ssh any any -> any any ("
                                           "msg:\"match SSH hash-server-string\"; ssh.hassh.server.string;"
                                           "content:\"umac-64-etm@openssh.com,umac-128-etm@openssh.com,hmac-sha2-256-etm@openssh.com,hmac-sha2-512-etm@openssh.com,hmac-sha1-etm@openssh.com,umac-64@openssh.com,umac-128@openssh.com,hmac-sha2-256,hmac-sha2-512,hmac-sha1\"; "
                                           "sid:1;)");
    FAIL_IF(s == NULL);
    ...
    r = AppLayerParserParse(NULL, alp_tctx, &f, ALPROTO_SSH,
                                STREAM_TOCLIENT, sshbuf3, sshlen3);
    FAIL_IF_NOT(r == 0); 
...
static void DetectSshHasshServerStringRegisterTests(void)
{
    UtRegisterTest("DetectSshHasshServerStringTest01", DetectSshHasshServerStringTest01);
}
