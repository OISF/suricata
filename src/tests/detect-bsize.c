...
static int DetectBsizeSigTest01(void)
{
    ...
    TEST_OK  ("alert http any any -> any any (file_data; content:\"/index.php\"; bsize:>1024; sid:6;)");
    TEST_OK  ("alert http any any -> any any (file_data; content:\"abdcef\"; content: \"g\"; bsize:1; sid:7;)");
    TEST_OK  ("alert http any any -> any any (file_data; content:\"abdcef\"; content: \"g\"; bsize:4; sid:8;)");
    TEST_OK  ("alert http any any -> any any (file_data; content:\"abcdefgh123456\"; bsize:<20; sid:9;)");
    TEST_OK  ("alert http any any -> any any (file_data; content:\"abcdefgh123456\"; bsize:15<>25; sid:10;)");
    TEST_FAIL("alert http any any -> any any (file_data; content:\"abcdefgh123456\"; bsize:2; sid:11;)");
    TEST_FAIL("alert http any any -> any any (file_data; content:\"abcdefgh123456\"; bsize:<13; sid:12;)");
    TEST_FAIL("alert http any any -> any any (file_data; content:\"abcdefgh123456\"; bsize:10<>15; sid:13;)");
    TEST_FAIL("alert http any any -> any any (file_data; content:\"abcdefghi123456\"; offset:12;  bsize:3; sid:14;)");
    TEST_FAIL("alert http any any -> any any (file_data; content:\"abc\"; offset:3; depth:3; bsize:3; sid:15;)");
    TEST_FAIL("alert http any any -> any any (file_data; content:\"abdcef\"; content: \"gh\"; bsize:1; sid:16;)");
    TEST_FAIL("alert http any any -> any any (file_data; content:\"abc\"; offset:3; bsize:3; sid:15;)");
