...
static int DetectBsizeSigTest01(void)
{
    ...
    TEST_FAIL("alert http any any -> any any (http.uri; content:\"abcdefgh123456\"; bsize:<13; "
              "sid:12;)");
    TEST_FAIL("alert http any any -> any any (http.uri; content:\"abcdef\"; content: \"g\"; bsize:1; "
            "sid:7;)");
    TEST_FAIL("alert http any any -> any any (http.uri; content:\"abcdef\"; content: \"g\"; bsize:4; "
            "sid:8;)");
