 ...
 */
static int DetectSshHasshServerTest01(void) {
    Flow f;
    ...
    s = de_ctx->sig_list = SigInit(de_ctx, "alert ssh any any -> any any ("
                                           "msg:\"match SSH hash-server\"; ssh.hassh.server; content:\"b12d2871a1189eff20364cf5333619ee\"; "
                                           "sid:1;)");
    FAIL_IF(s == NULL);
...
static void DetectSshHasshServerRegisterTests(void)
{
    UtRegisterTest("DetectSshHasshServerTest01", DetectSshHasshServerTest01);
}
