...
static int UpdatePcapStatsValue64NoChange01(void)
{
     ...
     */
    TestData data[] = { { .last = 0, .current = 0 }, { .last = 12345, .current = 12345 },
...
static int UpdatePcapStatsValue64NoOverflow01(void)
{
     ...
     */
    TestData data[] = { { .last = 0, .current = 1 }, { .last = 12345, .current = 34567 },
...
static int UpdatePcapStatsValue64Overflow01(void)
{
     ...
     * Last count is within first 32bit range, i.e. same as pcap_stat range.
     */
    TestData data[] = { { .last = 1, .current = 0 }, { .last = 12345, .current = 22 },
        { .last = 12345, .current = 12344 },
...
static int UpdatePcapStats64Assorted01(void)
{
    ...
    struct pcap_stat current = { .ps_recv = 12, .ps_drop = 2345, .ps_ifdrop = 9876 };
...
{
    UtRegisterTest("UpdatePcapStatsValue64NoChange01", UpdatePcapStatsValue64NoChange01);
    UtRegisterTest("UpdatePcapStatsValue64NoChange02", UpdatePcapStatsValue64NoChange02);
    UtRegisterTest("UpdatePcapStatsValue64NoOverflow01", UpdatePcapStatsValue64NoOverflow01);
    UtRegisterTest("UpdatePcapStatsValue64NoOverflow02", UpdatePcapStatsValue64NoOverflow02);
    UtRegisterTest("UpdatePcapStatsValue64Overflow01", UpdatePcapStatsValue64Overflow01);
    UtRegisterTest("UpdatePcapStatsValue64Overflow02", UpdatePcapStatsValue64Overflow02);
    UtRegisterTest("UpdatePcapStatsValue64Overflow03", UpdatePcapStatsValue64Overflow03);
