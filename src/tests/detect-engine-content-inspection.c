...
static int DetectEngineContentInspectionTest11(void) {
    TEST_HEADER;
    TEST_RUN("ab", 2, "content:\"a\"; starts_with; content:\"b\";", true, 2);
    TEST_RUN("ab", 2, "content:\"a\"; starts_with; content:\"b\"; within:1; distance:0;", true, 2);
    TEST_RUN("ab", 2, "content:\"ab\"; starts_with;", true, 1);
    TEST_RUN("ab", 2, "content:\"a\"; starts_with;", true, 1);
