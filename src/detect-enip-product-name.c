...
void DetectEnipProductNameRegister(void)
{
    ...
    sigmatch_table[DETECT_ENIP_PRODUCTNAME].desc = "sticky buffer to match EtherNet/IP product name";
    ...
    DetectAppLayerInspectEngineRegister2("enip.product_name", ALPROTO_ENIP,
            SIG_FLAG_TOCLIENT, 0,
            DetectEngineInspectBufferGeneric, GetData);

    DetectAppLayerMpmRegister2("enip.product_name", SIG_FLAG_TOCLIENT, 2,
            PrefilterGenericMpmRegister, GetData, ALPROTO_ENIP,
            1);
