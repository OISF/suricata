    ...
    if (strlen(arg2) > 0) {
        ...
        switch(arg2[0]) {
            ...
            case '>':
                ...
                if (ByteExtractStringUint8(&u8da.arg1, 10, strlen(arg3), arg3) < 0) {
            ...
            case '-':
                ...
                if (ByteExtractStringUint8(&u8da.arg1, 10, strlen(arg1), arg1) < 0) {
                    SCLogError(SC_ERR_BYTE_EXTRACT_FAILED, "ByteExtractStringUint8 failed");
                    return NULL;
                }
                if (ByteExtractStringUint8(&u8da.arg2, 10, strlen(arg3), arg3) < 0) {
                    SCLogError(SC_ERR_BYTE_EXTRACT_FAILED, "ByteExtractStringUint8 failed");
                    return NULL;
                }
