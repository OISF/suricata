...
static int DetectDetectionFilterTestSig1(void)
{
    ...
    s = de_ctx->sig_list = DetectEngineAppendSig(de_ctx,"alert tcp any any -> any 80 (msg:\"detection_filter Test\"; detection_filter: track by_dst, count 4, seconds 60; sid:1;)");
    FAIL_IF_NULL(s);
...
static int DetectDetectionFilterTestSig2(void)
{
    ...
    s = de_ctx->sig_list = DetectEngineAppendSig(de_ctx,"alert tcp any any -> any 80 (msg:\"detection_filter Test 2\"; detection_filter: track by_dst, count 4, seconds 60; sid:10;)");
    FAIL_IF_NULL(s);
...
static int DetectDetectionFilterTestSig3(void)
{
    ...
    s = de_ctx->sig_list = DetectEngineAppendSig(de_ctx,"drop tcp any any -> any 80 (msg:\"detection_filter Test 2\"; detection_filter: track by_dst, count 2, seconds 60; sid:10;)");
    FAIL_IF_NULL(s);
