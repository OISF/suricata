 ...
 */
static AppLayerReturn DNP3ParseRequest(Flow *f, void *state, AppLayerParserState *pstate,
 ...
 */
static AppLayerReturn DNP3ParseResponse(Flow *f, void *state, AppLayerParserState *pstate,
    const uint8_t *input, uint32_t input_len, void *local_data,
    const uint8_t flags)
{
    SCEnter();
