...
/**
 * \brief Thread that monitors the host buffer utilization.
 *
 * \param arg contains Thread Variables.
 *
  */
...
/**
 * \brief Instantiates the Statistics threads.
 *
  */
...
/**
 * \brief Sets up the hostbuffer NUMA configuration using NTPL commands
 *
 * \return true if the NTPL commands were successfully issued, false otherwise.
 *
  */
...
/**
 * \brief Sets the hashmode using NTPL commands.
 *
 * \return the filter ID if successful; zero otherwise.
 *
  */
...
/**
 * \brief Gets the mapping of NUMA nodes to hostbuffer/streams.
 *
 * \return The number of hostbuffers processed by this function.
 *
  */
...
/**
 * \brief Issues an NTPL string command.
 *
 * \return the filter ID of the NTPL filter
 *
  */
...
/**
 * \brief Deletes any NTPL filters that are instantiated on the hardware.
 *
 * \return the status value returned by the Napatech functions.
 *
  */
...
/**
 * \brief Configures the Napatech card according to information from the suricata config file
 *
 * \return the success/failure status as reported by the Napatech functions.
 *
  */
