...
/** value chosen to keep per-packet overhead low while still allowing
 *  some room to track chunks.
 *  SCTP has no hard limit on the number of chunks per packet.
 *  A packet can carry as many chunks as fit within the MTU,
