...
static int DetectEngineHttpRawHeaderTest33(void)
{
    TcpSession ssn;
    Packet *p = NULL;
    ThreadVars th_v;
    ...
    de_ctx->sig_list = SigInit(de_ctx,"alert http any any -> any any "
                               "(msg:\"http header test\"; flow:to_server; "
                               "content:\"one\"; http_raw_header; "
                               "content_len:=,45; http_raw_header; "
                               "sid:1;)");
    if (de_ctx->sig_list == NULL)
        goto end;
...
void DetectEngineHttpRawHeaderRegisterTests(void)
{
    ...
    UtRegisterTest("DetectEngineHttpRawHeaderTest33",
                   DetectEngineHttpRawHeaderTest33, 1);
#endif /* UNITTESTS */
