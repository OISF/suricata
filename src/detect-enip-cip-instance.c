...
void DetectEnipCipInstanceRegister(void)
{
    ...
    DetectAppLayerInspectEngineRegister2("enip.cip_instance", ALPROTO_ENIP, SIG_FLAG_TOSERVER, 0,
            DetectEngineInspectGenericList, NULL);
    DetectAppLayerInspectEngineRegister2("enip.cip_instance", ALPROTO_ENIP, SIG_FLAG_TOCLIENT, 0,
            DetectEngineInspectGenericList, NULL);
