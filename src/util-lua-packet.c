...
static const char suricata_packet_metatable[] = "suricata:packet::metatable";
...
static int LuaPacketGet(lua_State *luastate)
{
    ...
    s->p = p;
    luaL_getmetatable(luastate, suricata_packet_metatable);
...
{
    luaL_newmetatable(luastate, suricata_packet_metatable);
