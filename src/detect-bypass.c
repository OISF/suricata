...
void DetectBypassRegister(void)
{
    ...
    sigmatch_table[DETECT_BYPASS].desc = "call the offloading callback when the match of a sig is complete";
...
static int DetectBypassTestSig01(void)
{
    ...
    livedev->BypassCallback = BypassCallback;
