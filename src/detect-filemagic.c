...
void DetectFilemagicRegister(void)
{
    ...
    AppProto protos_ts[] = {
        ALPROTO_SMTP, ALPROTO_FTP, ALPROTO_SMB, ALPROTO_NFS, ALPROTO_HTTP2, 0 };
    AppProto protos_tc[] = {
        ALPROTO_FTP, ALPROTO_SMB, ALPROTO_NFS, ALPROTO_HTTP2, 0 };

    DetectAppLayerInspectEngineRegister2("file.magic", ALPROTO_HTTP,
    ...
    DetectAppLayerMpmRegister2("file.magic", SIG_FLAG_TOSERVER, 2,
            PrefilterMpmFilemagicRegister, NULL, ALPROTO_HTTP, HTP_REQUEST_BODY);

    DetectAppLayerInspectEngineRegister2("file.magic", ALPROTO_HTTP,
            SIG_FLAG_TOCLIENT, HTP_RESPONSE_BODY,
            DetectEngineInspectFilemagic, NULL);
    DetectAppLayerMpmRegister2("file.magic", SIG_FLAG_TOCLIENT, 2,
            PrefilterMpmFilemagicRegister, NULL, ALPROTO_HTTP, HTP_RESPONSE_BODY);
