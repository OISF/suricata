...
";
    ...
    const char *sigs[] = {
        "alert http any any -> any any (content:\"ab\"; file_data; sid:1;)",
        "alert http any any -> any any (content:\"bc\"; file_data; sid:2;)",
        "alert http any any -> any any (content:\"cdef\"; file_data; sid:3;)",
        "alert http any any -> any any (content:\"ef\"; file_data; sid:4;)",
        NULL,
    };

    int i;

    for (i = 0; sigs[i] != NULL; i++) {
        if (!RunTest(steps, sigs[i], yaml))
            return 0;
    }
...
";
    ...
    const char *sigs[] = {
        "alert http any any -> any any (content:\"ab\"; file_data; sid:1;)",
        "alert http any any -> any any (content:\"abcd\"; file_data; sid:2;)",
        "alert http any any -> any any (content:\"d123456789\"; file_data; sid:3;)",
        NULL,
    };
...
";
    ...
    const char *sigs[] = {
        "alert http any any -> any any (content:\"123\"; file_data; sid:1;)",
        "alert http any any -> any any (content:\"3456\"; file_data; sid:2;)",
        NULL,
    };
...
";
    ...
    const char *sigs[] = {
        "alert http any any -> any any (content:\"ab\"; file_data; sid:1;)",
        "alert http any any -> any any (content:\"abc\"; file_data; sid:2;)",
        "alert http any any -> any any (content:\"bcde\"; file_data; sid:3;)",
        NULL,
    };
...
";
    ...
    const char *sigs[] = {
        "alert http any any -> any any (content:\"abcd\"; file_data; sid:1;)",
        "alert http any any -> any any (content:\"dfegh\"; file_data; sid:2;)",
        NULL,
    };
...
";
    ...
    const char *sigs[] = {
        "alert http any any -> any any (content:\"abcd\"; file_data; sid:1;)",
        "alert http any any -> any any (content:\"defghijklm\"; file_data; sid:2;)",
        NULL,
    };
