                                        ...
                                        HtpTxUserData *htud, int index)
{
    ...
    while (cur != NULL) {
        ...
        if (det_ctx->hsbd[index].buffer == NULL) {
            ...
            if ((htp_state->cfg->response_inspect_window + cur->len) > window_size)
        ...
        /* see if we can filter out chunks */
        if (htud->response_body.content_len_so_far > htp_state->cfg->response_inspect_window) {
            left_edge = htud->response_body.content_len_so_far - htp_state->cfg->response_inspect_window;
