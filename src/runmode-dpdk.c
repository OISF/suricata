...
/**
 * Reset the remaining auto-assigned threads count so next call of AutoRemainingThreadsInit()
 * will recalculate the number of remaining auto-assigned threads.
 */
