...
void printUUID(char *type, struct uuid_entry  *uuid) {
    uint8_t i = 0;
    printf("%s UUID [%2u] %s ", type, uuid->ctxid, (uuid->result == 0) ? "Accepted" : "Rejected");
    for (i = 0; i < 16; i++) {
    ...
    switch (sstate->dcerpc.type) {
        ...
        case ALTER_CONTEXT:
            ...
            while (sstate->numctxitemsleft && sstate->bytesprocessed < sstate->dcerpc.frag_length &&
                    input_len) {
                retval = DCERPCParseBINDCTXItem(f, dcerpc_state, pstate, input + parsed, input_len,
                        output);
        ...
        case ALTER_CONTEXT_RESP:
            ...
            while(sstate->bytesprocessed >=  DCERPC_HDR_LEN + 10 + sstate->pad + sstate->secondaryaddrlen &&
                ...
                retval = DCERPCGetCTXItems(f, dcerpc_state, pstate, input + parsed, input_len,
                        output);
                parsed += retval;
                input_len -= retval;
            }
            ...
            while (sstate->numctxitemsleft && input_len) {
                retval = DCERPCParseBINDACKCTXItem(f, dcerpc_state, pstate, input + parsed, input_len,
                        output);
...
int DCERPCParserTest01(void) {
   ...
   /* uint8_t dcerpcbind[] = {
         };

    uint8_t dcerpcbindack[] = {
        0x05, 0x00, 0x0c, 0x03,
        0x10, 0x00, 0x00, 0x00, 0x6c, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xb8, 0x10, 0xb8, 0x10,
        0xce, 0x47, 0x00, 0x00, 0x0c, 0x00, 0x5c, 0x50, 0x49, 0x50, 0x45, 0x5c, 0x6c, 0x73, 0x61, 0x73,
        0x73, 0x00, 0xf6, 0x6e, 0x18, 0x00, 0x00, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        0x2b, 0x10, 0x48, 0x60, 0x02, 0x00, 0x00, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    int r = AppLayerParse(&f, ALPROTO_DCERPC, STREAM_TOSERVER, dcerpcbind, bindlen, FALSE);
    if (r != 0) {
    ...
    r = AppLayerParse(&f, ALPROTO_DCERPC, STREAM_TOCLIENT|STREAM_EOF, dcerpcbindack, bindacklen, FALSE);
