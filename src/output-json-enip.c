...
static int JsonEnipLogger(ThreadVars *tv, void *thread_data, const Packet *p, Flow *f,
...
void JsonEnipLogRegister(void)
{
    ...
    OutputRegisterTxSubModule(LOGGER_JSON_TX, "eve-log", "JsonEnipLog", "eve-log.enip",
            OutputEnipLogInitSub, ALPROTO_ENIP, JsonEnipLogger,
            JsonEnipLogThreadInit, JsonEnipLogThreadDeinit, NULL);
}
