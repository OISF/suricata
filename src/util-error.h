...
typedef enum {
    ...
    SC_ERR_DPDKINTEL_CONFIG_FAILED,
    SC_ERR_DPDKINTEL_MEM_FAILED,
    SC_ERR_DPDKINTEL_RECEIVE_REGISTER_FAILED,
    SC_ERR_DPDKINTEL_DECODE_REGISTER_FAILED,
    SC_ERR_DPDKINTEL_DPDKAPI,
    SC_ERR_DPDKINTEL_SCAPI,
} SCError;
