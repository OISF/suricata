...
typedef struct MD5ContextStr SCMD5Context;
...
*/
extern SCMD5Context *MD5_NewContext(HASH_HashType hash);
...
**	"cx" the context
*/
extern void MD5_DestroyContext(SCMD5Context *cx);

/*
** Reset an MD5 context, preparing it for a fresh round of hashing
*/
extern void MD5_Begin(SCMD5Context *cx);
...
*/
extern void MD5_Update(SCMD5Context *cx,
		       const unsigned char *input, unsigned int inputLen);
...
**	   stored in "digest"
*/
extern void MD5_End(SCMD5Context *cx, unsigned char *digest,
...
**	   stored in "digest"
*/
extern void MD5_EndRaw(SCMD5Context *cx, unsigned char *digest,
		       unsigned int *digestLen, unsigned int maxDigestLen);
 ...
 *  returns size;
 */
extern unsigned int MD5_FlattenSize(SCMD5Context *cx);
 ...
 *  returns status;
 */
extern SECStatus MD5_Flatten(SCMD5Context *cx,unsigned char *space);
 ...
 */
extern SCMD5Context * MD5_Resurrect(unsigned char *space, void *arg);
extern void MD5_Clone(SCMD5Context *dest, SCMD5Context *src);

/*
** trace the intermediate state info of the MD5 hash.
*/
extern void MD5_TraceState(SCMD5Context *cx);
