...
static enum ExceptionPolicyTargetValues ExceptionPolicyFlag(enum PacketDropReason drop_reason)
{
    switch (drop_reason) {
        ...
        default:
            return EXCEPTION_TARGET_FLAG_NONE;
    }

    return EXCEPTION_TARGET_FLAG_NONE;
}

const char *ExceptionPolicyTargetFlagToString(enum ExceptionPolicyTargetValues target_flag)
{
    switch (target_flag) {
...
enum ExceptionPolicy ExceptionPolicyTargetPolicy(enum ExceptionPolicyTargetValues target_flag)
{
    switch (target_flag) {
        case EXCEPTION_TARGET_FLAG_DEFRAG_MEMCAP:
