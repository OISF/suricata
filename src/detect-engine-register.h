...
enum DetectKeywordId {
    ...
    DETECT_AL_IKEV1_EXCH_TYPE,
    DETECT_AL_IKEV1_SPI_INITIATOR,
    DETECT_AL_IKEV1_SPI_RESPONDER,
    DETECT_AL_IKEV1_VENDOR,
    DETECT_AL_IKEV1_CHOSEN_SA,
    DETECT_AL_IKEV1_KEY_EXCHANGE_PAYLOAD_LENGTH,
    DETECT_AL_IKEV1_NONCE_PAYLOAD_LENGTH,
    DETECT_AL_IKEV1_CLIENT_NONCE,
    DETECT_AL_IKEV1_SERVER_NONCE,
    DETECT_AL_IKEV1_CLIENT_KEY_EXCHANGE,
    DETECT_AL_IKEV1_SERVER_KEY_EXCHANGE,
