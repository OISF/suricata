...
#define SIGMATCH_BAN_FIREWALL_SCOPE_TX     (1UL << (25))
#define SIGMATCH_BAN_FIREWALL_SCOPE_HOOK   (1UL << (26))
/** keyword cannot be unsed in combination with indicated action */
#define SIGMATCH_BAN_ACTION_CONFIG (1UL << (27))
#define SIGMATCH_BAN_ACTION_DROP   (1UL << (28))
#define SIGMATCH_BAN_ACTION_REJECT (1UL << (29))
