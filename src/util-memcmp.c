...
static int MemcmpTestExactSCMemcmpAVX512_LT16(void)
{
#ifdef PROFILING
...
static int MemcmpTestExactSCMemcmpAVX512_LT32(void)
{
#ifdef PROFILING
#if defined(__AVX512VBMI2__)
...
static int MemcmpTestExactSCMemcmpAVX512_LT64(void)
{
#ifdef PROFILING
#if defined(__AVX512VBMI2__)
...
static int MemcmpTestExactSCMemcmpNeon(void)
{
#ifdef PROFILING
...
static int MemcmpTestLowercaseAVX512_LT16(void)
{
#ifdef PROFILING
#if defined(__AVX512VBMI2__)
...
static int MemcmpTestLowercaseAVX512_LT32(void)
{
#ifdef PROFILING
#if defined(__AVX512VBMI2__)
...
static int MemcmpTestLowercaseAVX512_LT64(void)
{
#ifdef PROFILING
#if defined(__AVX512VBMI2__)
...
static int MemcmpTestLowercaseAVX512_128(void)
{
#ifdef PROFILING
#if defined(__AVX512VL__) && defined(__AVX512BW__)
...
void MemcmpRegisterTests(void)
{
    ...
    UtRegisterTest("MemcmpTestExactSCMemcmpAVX512_LT16", MemcmpTestExactSCMemcmpAVX512_LT16);
    UtRegisterTest("MemcmpTestExactSCMemcmpAVX512_LT32", MemcmpTestExactSCMemcmpAVX512_LT32);
    UtRegisterTest("MemcmpTestExactSCMemcmpAVX512_LT64", MemcmpTestExactSCMemcmpAVX512_LT64);
    ...
    UtRegisterTest("MemcmpTestExactSCMemcmpNeon", MemcmpTestExactSCMemcmpNeon);
    ...
    UtRegisterTest("MemcmpTestLowercaseAVX512_LT16", MemcmpTestLowercaseAVX512_LT16);
    UtRegisterTest("MemcmpTestLowercaseAVX512_LT32", MemcmpTestLowercaseAVX512_LT32);
    UtRegisterTest("MemcmpTestLowercaseAVX512_LT64", MemcmpTestLowercaseAVX512_LT64);
