 ...
 */
#define SCControlMutex pthread_mutex_t
#define SCControlMutexAttr pthread_mutexattr_t
#define SCControlMutexDestroy pthread_mutex_destroy
...
#define SCControlMutexInit(mut, mutattr ) pthread_mutex_init(mut, mutattr)
#define SCControlMutexLock(mut) pthread_mutex_lock(mut)
#define SCControlMutexTrylock(mut) pthread_mutex_trylock(mut)
#define SCControlMutexUnlock(mut) pthread_mutex_unlock(mut)
#endif /* DBG_THREADS */
...
#define SCControlCondT pthread_cond_t
#define SCControlCondInit pthread_cond_init
#define SCControlCondSignal pthread_cond_signal
#define SCControlCondTimedwait pthread_cond_timedwait
#define SCControlCondDestroy pthread_cond_destroy
