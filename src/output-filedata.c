...
static int CallLoggers(ThreadVars *tv, OutputLoggerThreadStore *store_list, Packet *p,
        File *ff, void *tx, const uint64_t tx_id, const uint8_t *data, uint32_t data_len,
...
{
    BUG_ON((file->flags & FILE_STORED) != 0);
