 ...
 * \return -1 On error
 */
int StringParseUint64wValidation(uint64_t *res, int base, uint16_t len, const char *str, uint64_t min, uint64_t max);
 ...
 * \return -1 On error
 */
int StringParseUint32wValidation(uint32_t *res, int base, uint16_t len, const char *str, uint32_t min, uint32_t max);
 ...
 * \return -1 On error
 */
int StringParseUint16wValidation(uint16_t *res, int base, uint16_t len, const char *str, uint16_t min, uint16_t max);
 ...
 * \return -1 On error
 */
int StringParseUint8wValidation(uint8_t *res, int base, uint16_t len, const char *str, uint8_t min, uint8_t max);
 ...
 * \return -1 On error
 */
int StringParseInt64wValidation(int64_t *res, int base, uint16_t len, const char *str, int64_t min, int64_t max);
 ...
 * \return -1 On error
 */
int StringParseInt32wValidation(int32_t *res, int base, uint16_t len, const char *str, int32_t min, int32_t max);
 ...
 * \return -1 On error
 */
int StringParseInt16wValidation(int16_t *res, int base, uint16_t len, const char *str, int16_t min, int16_t max);
 ...
 * \return -1 On error
 */
int StringParseInt8wValidation(int8_t *res, int base, uint16_t len, const char *str, int8_t min, int8_t max);
