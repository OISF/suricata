...
static inline int SCMemcmpAVX2_512(const uint8_t *s1, const uint8_t *s2, size_t len)
{
    ...
    do {
        ...
        __m256i b11 = _mm256_lddqu_si256((const __m256i *)(s1 + offset));
        __m256i b12 = _mm256_lddqu_si256((const __m256i *)(s1 + offset));

        __m256i b21 = _mm256_lddqu_si256((const __m256i *)(s2 + offset + 32));
        __m256i b22 = _mm256_lddqu_si256((const __m256i *)(s2 + offset + 32));

        __m256i c1 = _mm256_cmpeq_epi8(b11, b21);
        __m256i c2 = _mm256_cmpeq_epi8(b12, b22);
