...
#define CFG_FIELDS                                                                                 \
    ...
    CFG_ENTRY(logging0outputs0console0enabled)                                                     \
    CFG_ENTRY(logging0outputs0file0enabled)                                                        \
    CFG_ENTRY(logging0outputs0file0filename)                                                       \
    CFG_ENTRY(logging0outputs0callback0enabled)                                                    \
