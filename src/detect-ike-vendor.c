...
void DetectIkeVendorRegister(void)
{
    ...
    DetectAppLayerMpmRegister2("ikev1.vendor", SIG_FLAG_TOSERVER, 1, PrefilterMpmIkeVendorRegister,
            NULL, ALPROTO_IKE, 1);

    DetectAppLayerInspectEngineRegister2(
            "ikev1.vendor", ALPROTO_IKE, SIG_FLAG_TOSERVER, 1, DetectEngineInspectIkeVendor, NULL);
