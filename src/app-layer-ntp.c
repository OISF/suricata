...
#include "rust-external-ntp-gen.h"
...
void RegisterNTPParsers(void)
{
    ...
    if (AppLayerProtoDetectConfProtoDetectionEnabled("tcp", proto_name)) {
        ...
        SCLogNotice("NTP UDP protocol detection enabled.");
        ...
        if (RunmodeIsUnittests()) {
            ...
            if (!AppLayerProtoDetectPPParseConfPorts("tcp", IPPROTO_UDP,
                    ...
                    NTPProbingParser, NULL)) {
                SCLogNotice("No NTP app-layer configuration, enabling NTP"
        ...
        SCLogNotice("Protocol detecter and parser disabled for NTP.");
        return;
    }
