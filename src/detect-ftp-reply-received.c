        ...
        void *state, void *txv, const Signature *s, const SigMatchCtx *m)
{
    ...
    return 1 ? ftprrd->received == tx->done : 0;
}
...
void DetectFtpReplyReceivedRegister(void)
{
    ...
    sigmatch_table[DETECT_FTP_REPLY_RECEIVED].url = "/rules/ftp-keywords.html#ftpdata-command";
