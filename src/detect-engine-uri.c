...
static int UriTestSig40(void)
{
    int result = 0;
    Flow f;
    HtpState *http_state = NULL;
    uint8_t http_buf1[] = "POST /xxone HTTP/1.0\r\n"
        "User-Agent: Mozilla/1.0\r\n"
        "Cookie: hellocatch\r\n\r\n";
    uint32_t http_buf1_len = sizeof(http_buf1) - 1;
    TcpSession ssn;
...
static int UriTestSig41(void)
{
    int result = 0;
    Flow f;
    HtpState *http_state = NULL;
    uint8_t http_buf1[] = "POST /oneself HTTP/1.0\r\n"
        "User-Agent: Mozilla/1.0\r\n"
        "Cookie: hellocatch\r\n\r\n";
    uint32_t http_buf1_len = sizeof(http_buf1) - 1;
    TcpSession ssn;
...
void UriRegisterTests(void)
{
    ...
    UtRegisterTest("UriTestSig40", UriTestSig40, 1);
    UtRegisterTest("UriTestSig41", UriTestSig41, 1);
    UtRegisterTest("UriTestSig42", UriTestSig42, 1);
#endif /* UNITTESTS */
