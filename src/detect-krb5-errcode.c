...
/**
 * \brief Registration function for krb5.err_code: keyword
 *
 * This function is called once in the 'lifetime' of the engine.
 */
void DetectKrb5ErrCodeRegister(void) {
    sigmatch_table[DETECT_AL_KRB5_ERRCODE].name = "krb5.err_code";
    sigmatch_table[DETECT_AL_KRB5_ERRCODE].desc = "match Kerberos 5 message type";
    sigmatch_table[DETECT_AL_KRB5_ERRCODE].url = DOC_URL DOC_VERSION "/rules/kerberos-keywords.html#krb5-err_code";
...
/**
 * \brief This function is used to parse options passed via krb5.errcode: keyword
 *
 * \param krb5str Pointer to the user provided krb5.err_code options
 *
...
/**
 * \brief parse the options from the 'krb5.err_code' keyword in the rule into
...
static int DetectKrb5ErrCodeSignatureTest01 (void)
{
    ...
    Signature *sig = DetectEngineAppendSig(de_ctx, "alert krb5 any any -> any any (krb5.err_code:10; sid:1; rev:1;)");
    FAIL_IF_NULL(sig);
