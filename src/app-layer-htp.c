...
static int HTPStateGetAlstateProgressDoneValue(uint8_t direction);
...
void RegisterHTPParsers(void)
{
    ...
    AppLayerRegisterGetAlstateProgressDoneValue(ALPROTO_HTTP, HTPStateGetAlstateProgressDoneValue);
