...
void DetectSCTPHasInitRegister(void)
{
    ...
    sigmatch_table[DETECT_SCTP_HAS_INIT].desc = "match if the SCTP packet contains an INIT chunk";
    sigmatch_table[DETECT_SCTP_HAS_INIT].url = "/rules/sctp-keywords.html#sctp-has-init";
