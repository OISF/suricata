...
#ifdef UNITTESTS
static void DetectBacNetIpbacnet_bvlcfunRegisterTests(void);
#endif
...
void DetectBacNetIpbacnet_bvlcfunRegister(void)
{
    ...
    DetectAppLayerInspectEngineRegister2(
            "bacnetip.bvlcfun", ALPROTO_BACNETIP, SIG_FLAG_TOSERVER, 0, DetectEngineInspectGenericList, NULL);

    DetectAppLayerInspectEngineRegister2(
            "bacnetip.bvlcfun", ALPROTO_BACNETIP, SIG_FLAG_TOCLIENT, 0, DetectEngineInspectGenericList, NULL);
