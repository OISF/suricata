...
#ifndef __APP_LAYER_ECHO_H__
#define __APP_LAYER_ECHO_H__

#include "detect-engine-state.h"

#include "queue.h"

void RegisterEchoParsers(void);
void EchoParserRegisterTests(void);

typedef struct EchoTransaction_ {
    ...
    TAILQ_ENTRY(EchoTransaction_) next;

} EchoTransaction;

typedef struct EchoState_ {

    TAILQ_HEAD(, EchoTransaction_) tx_list; /**< List of Echo transactions
