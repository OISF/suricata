...
static AppLayerReturn RustDNSTCPParseRequest(Flow *f, void *state,
...
static AppLayerReturn RustDNSTCPParseResponse(Flow *f, void *state,
        AppLayerParserState *pstate, const uint8_t *input, uint32_t input_len,
        void *local_data, const uint8_t flags)
{
...
static int RustDNSTCPParserTestMultiRecord(void)
{
    ...
    AppLayerReturn r = RustDNSTCPParseRequest(f, f->alstate, NULL, req, reqlen,
                    NULL, STREAM_START);
    FAIL_IF(r.status != 0);
