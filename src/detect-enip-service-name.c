...
void DetectEnipServiceNameRegister(void)
{
    ...
    DetectAppLayerInspectEngineRegister2("enip.service_name", ALPROTO_ENIP, SIG_FLAG_TOCLIENT, 0,
            DetectEngineInspectBufferGeneric, GetData);
    DetectAppLayerMpmRegister2("enip.service_name", SIG_FLAG_TOCLIENT, 2,
