...
static int DetectEngineInspectIkeExchTypeGeneric(ThreadVars *tv,
        DetectEngineCtx *de_ctx, DetectEngineThreadCtx *det_ctx,
        const Signature *s, const SigMatchData *smd,
        Flow *f, uint8_t flags, void *alstate,
        void *txv, uint64_t tx_id);

static int DetectIkeExchTypeMatch (DetectEngineThreadCtx *, Flow *,
...
void DetectIkeExchTypeRegister (void)
{
    ...
    DetectAppLayerInspectEngineRegister("ike.exchtype",
            ALPROTO_IKE, SIG_FLAG_TOSERVER, 1,
            DetectEngineInspectIkeExchTypeGeneric);
 ...
 * \retval 1 match.
 */
static int DetectIkeExchTypeMatch (DetectEngineThreadCtx *det_ctx,
                                   ...
                                   const SigMatchCtx *ctx)
{
    ...
    return DetectU8Match(exch_type, du8);
}
