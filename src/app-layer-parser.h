...
typedef struct AppLayerProto_ {
    ...
    int (*StateGetAlstateProgressDoneValue)(uint8_t direction);
} AppLayerProto;
...
void AppLayerRegisterGetTx(uint16_t alproto,
                           void *(*StateGetTx)(void *alstate, uint64_t tx_id));
void AppLayerRegisterGetAlstateProgressDoneValue(uint16_t alproto,
 ...
 */
int AppLayerGetAlstateProgressDoneValue(uint16_t alproto, uint8_t direction);
