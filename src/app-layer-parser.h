...
typedef struct AppLayerProto_ {
    ...
    uint64_t (*StateGetNoOfTxs)(void *alstate);
    void *(*StateGetTx)(void *alstate, uint64_t tx_id);
    int (*StateProgressDoneValue)(uint8_t direction);
} AppLayerProto;
...
void AppLayerRegisterGetProgressFunc(uint16_t alproto,
                                     int (*StateGetProgress)(void *alstate, uint8_t direction));
void AppLayerRegisterGetNoOfTxs(uint16_t alproto,
                                uint64_t (*StateGetNoOfTxs)(void *alstate));
void AppLayerRegisterGetTx(uint16_t alproto,
                           void *(*StateGetTx)(void *alstate, uint64_t tx_id));
void AppLayerRegisterGetProgressDoneValue(uint16_t alproto,
                                          int (*StateProgressDoneValue)(uint8_t direction));
 ...
 */
int AppLayerGetProgress(uint16_t alproto, void *state, uint8_t direction);
 ...
 */
uint64_t AppLayerGetNoOfTxs(uint16_t alproto, void *alstate);
 ...
 */
int AppLayerGetProgressDoneValue(uint16_t alproto, uint8_t direction);
