...
{
    return rs_enip_tx_has_cip_attribute(txv, ctx);
}
...
void DetectEnipCipAttributeRegister(void)
{
    ...
    DetectAppLayerInspectEngineRegister2("enip.cip_attribute", ALPROTO_ENIP, SIG_FLAG_TOSERVER, 0,
            DetectEngineInspectGenericList, NULL);
    DetectAppLayerInspectEngineRegister2("enip.cip_attribute", ALPROTO_ENIP, SIG_FLAG_TOCLIENT, 0,
            DetectEngineInspectGenericList, NULL);
