...
/**
 * \brief Registration function for krb5.msg_type: keyword
 *
 * This function is called once in the 'lifetime' of the engine.
 */
void DetectKrb5MsgTypeRegister(void) {
    sigmatch_table[DETECT_AL_KRB5_MSGTYPE].name = "krb5.msg_type";
    sigmatch_table[DETECT_AL_KRB5_MSGTYPE].desc = "match Kerberos 5 message type";
    sigmatch_table[DETECT_AL_KRB5_MSGTYPE].url = DOC_URL DOC_VERSION "/rules/kerberos-keywords.html#krb5-msg_type";
 ...
 *
 * \param krb5str Pointer to the user provided krb5.msg_type options
 *
...
/**
 * \brief parse the options from the 'krb5.msg_type' keyword in the rule into
...
static int DetectKrb5MsgTypeSignatureTest01 (void)
{
    ...
    Signature *sig = DetectEngineAppendSig(de_ctx, "alert krb5 any any -> any any (krb5.msg_type:10; sid:1; rev:1;)");
    FAIL_IF_NULL(sig);
