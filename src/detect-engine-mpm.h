...
void DetectMpmInitializeRecordMpms(DetectEngineCtx *de_ctx);
int DetectMpmPrepareRecordMpms(DetectEngineCtx *de_ctx);
...
void DetectRecordMpmRegister(const char *name, int direction, int priority,
        int (*PrefilterRegister)(DetectEngineCtx *de_ctx, SigGroupHead *sgh, MpmCtx *mpm_ctx,
                const DetectBufferMpmRegistery *mpm_reg, int list_id),
        AppProto alproto, uint8_t type);
void DetectRecordMpmRegisterByParentId(DetectEngineCtx *de_ctx, const int id, const int parent_id,
        DetectEngineTransforms *transforms);
void DetectEngineRecordMpmRegister(DetectEngineCtx *de_ctx, const char *name, int direction, int priority,
        int (*PrefilterRegister)(DetectEngineCtx *de_ctx, SigGroupHead *sgh, MpmCtx *mpm_ctx,
                const DetectBufferMpmRegistery *mpm_reg, int list_id),
        AppProto alproto, uint8_t type);
