...
static TmEcode ParseCommandLine(int argc, char** argv, SCInstance *suri)
{
    ...
    struct option long_opts[] = {
        ...
        {"list-detect-protocols", 0, &list_detect_protocols, 1},
    ...
    if (list_detect_protocols)
        suri->run_mode = RUNMODE_LIST_DETECT_PROTOCOLS;
    if (list_keywords)
...
static int StartInternalRunMode(SCInstance *suri, int argc, char **argv)
{
    ...
    switch(suri->run_mode) {
        ...
        case RUNMODE_LIST_APP_LAYERS:
            ...
            return TM_ECODE_DONE;
        case RUNMODE_LIST_DETECT_PROTOCOLS:
            ListDetectProtocols();
            return TM_ECODE_DONE;
