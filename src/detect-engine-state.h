...
#define DE_STATE_FLAG_HRUD_INSPECT        (1 << 2)
#define DE_STATE_FLAG_HCBD_INSPECT        (1 << 3)
#define DE_STATE_FLAG_HSBD_INSPECT        (1 << 4)
#define DE_STATE_FLAG_HHD_INSPECT         (1 << 5)
#define DE_STATE_FLAG_HRHD_INSPECT        (1 << 6)
#define DE_STATE_FLAG_HHHD_INSPECT        (1 << 7)
#define DE_STATE_FLAG_HRHHD_INSPECT       (1 << 8)
#define DE_STATE_FLAG_HUAD_INSPECT        (1 << 9)
#define DE_STATE_FLAG_HMD_INSPECT         (1 << 10)
#define DE_STATE_FLAG_HCD_INSPECT         (1 << 11)
#define DE_STATE_FLAG_HSMD_INSPECT        (1 << 12)
#define DE_STATE_FLAG_HSCD_INSPECT        (1 << 13)
#define DE_STATE_FLAG_FILE_TC_INSPECT     (1 << 14)
#define DE_STATE_FLAG_FILE_TS_INSPECT     (1 << 15)
#define DE_STATE_FLAG_FULL_INSPECT        (1 << 16)
#define DE_STATE_FLAG_SIG_CANT_MATCH      (1 << 17)
...
#define APP_STAGE_NOT_DONE 0
#define APP_STAGE_DONE 1
