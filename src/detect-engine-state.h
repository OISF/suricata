...
#define DE_STATE_FLAG_DNP3_DATA_INSPECT   (1 << 25)
#define DE_STATE_FLAG_DNP3_INSPECT        (1 << 26)
#define DE_STATE_FLAG_DNP3_LUA_INSPECT    (1 << 27)
#define DE_STATE_FLAG_TEMPLATE_BUFFER_INSPECT (1 << 28)
