...
#define KEYWORD_DOC_CLIENT_NONCE  "ike-keywords.html#ikev1-client_nonce_payload";
...
#define KEYWORD_DOC_SERVER_NONCE  "ike-keywords.html#ikev1-server_nonce_payload";
...
void DetectIkeNonceRegister(void)
{
    ...
    sigmatch_table[DETECT_AL_IKE_CLIENT_NONCE].name = KEYWORD_NAME_CLIENT_NONCE;
    sigmatch_table[DETECT_AL_IKE_CLIENT_NONCE].url = "/rules/" KEYWORD_DOC_CLIENT_NONCE
    sigmatch_table[DETECT_AL_IKE_CLIENT_NONCE].desc = "sticky buffer to match on the IKEv1 client_nonce_payload";
    sigmatch_table[DETECT_AL_IKE_CLIENT_NONCE].Setup = DetectClientNonceSetup;
    sigmatch_table[DETECT_AL_IKE_CLIENT_NONCE].flags |= SIGMATCH_NOOPT|SIGMATCH_INFO_STICKY_BUFFER;

    DetectAppLayerInspectEngineRegister2(BUFFER_NAME_CLIENT_NONCE, ALPROTO_IKE,
            SIG_FLAG_TOSERVER, 3,
    ...
    DetectAppLayerMpmRegister2(BUFFER_NAME_CLIENT_NONCE, SIG_FLAG_TOSERVER, 1,
            PrefilterGenericMpmRegister, GetClientNonceData, ALPROTO_IKE,
            3);
    ...
    sigmatch_table[DETECT_AL_IKE_SERVER_NONCE].name = KEYWORD_NAME_SERVER_NONCE;
    sigmatch_table[DETECT_AL_IKE_SERVER_NONCE].url = "/rules/" KEYWORD_DOC_SERVER_NONCE
    sigmatch_table[DETECT_AL_IKE_SERVER_NONCE].desc = "sticky buffer to match on the IKEv1 server_nonce_payload";
    sigmatch_table[DETECT_AL_IKE_SERVER_NONCE].Setup = DetectServerNonceSetup;
    sigmatch_table[DETECT_AL_IKE_SERVER_NONCE].flags |= SIGMATCH_NOOPT|SIGMATCH_INFO_STICKY_BUFFER;

    DetectAppLayerInspectEngineRegister2(BUFFER_NAME_SERVER_NONCE, ALPROTO_IKE,
            SIG_FLAG_TOCLIENT, 4,
    ...
    DetectAppLayerMpmRegister2(BUFFER_NAME_SERVER_NONCE, SIG_FLAG_TOCLIENT, 1,
            PrefilterGenericMpmRegister, GetServerNonceData, ALPROTO_IKE,
            4);
