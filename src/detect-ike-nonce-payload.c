...
#define KEYWORD_NAME_NONCE "ikev1.nonce_payload"
#define KEYWORD_DOC_NONCE  "ike-keywords.html#ikev1-nonce_payload";
#define BUFFER_NAME_NONCE  "ikev1.nonce_payload"
#define BUFFER_DESC_NONCE  "ikev1 nonce payload"
...
void DetectIkeNonceRegister(void)
{
    ...
    sigmatch_table[DETECT_AL_IKE_NONCE].url = "/rules/" KEYWORD_DOC_NONCE
    sigmatch_table[DETECT_AL_IKE_NONCE].desc = "sticky buffer to match on the IKEv1 nonce_payload";
    ...
    DetectAppLayerInspectEngineRegister2(BUFFER_NAME_NONCE, ALPROTO_IKE,
            SIG_FLAG_TOSERVER, 1,
            DetectEngineInspectBufferGeneric, GetNonceData);

    DetectAppLayerMpmRegister2(BUFFER_NAME_NONCE, SIG_FLAG_TOSERVER, 1,
            PrefilterGenericMpmRegister, GetNonceData, ALPROTO_IKE,
            1);
    ...
    DetectAppLayerMpmRegister2(BUFFER_NAME_NONCE, SIG_FLAG_TOCLIENT, 1,
            PrefilterGenericMpmRegister, GetNonceData, ALPROTO_IKE,
            1);
