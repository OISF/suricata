...
{
    return rs_enip_tx_has_cip_extendedstatus(txv, ctx);
}
...
void DetectEnipCipExtendedstatusRegister(void)
{
    ...
    DetectAppLayerInspectEngineRegister2("enip.cip_extendedstatus", ALPROTO_ENIP, SIG_FLAG_TOSERVER,
            0, DetectEngineInspectGenericList, NULL);
    DetectAppLayerInspectEngineRegister2("enip.cip_extendedstatus", ALPROTO_ENIP, SIG_FLAG_TOCLIENT,
            0, DetectEngineInspectGenericList, NULL);
