...
static int PrefilterMpmHttpRequestBodyRegister(DetectEngineCtx *de_ctx,
...
void DetectHttpClientBodyRegister(void)
{
    ...
    DetectAppLayerMpmRegister2("http_client_body", SIG_FLAG_TOSERVER, 2,
            PrefilterMpmHttpRequestBodyRegister, NULL, ALPROTO_HTTP1,
            HTP_REQUEST_BODY);
...
static inline InspectionBuffer *HttpRequestBodyXformsGetDataCallback(
        ...
        const Signature *s, Flow *f, uint8_t flags, void *alstate, void *txv, uint64_t tx_id)
{
    ...
    const InspectionBuffer *buffer = HttpRequestBodyGetDataCallback(det_ctx,
        ...
        const uint64_t idx, const uint8_t flags)
{
    ...
    InspectionBuffer *buffer = HttpRequestBodyGetDataCallback(det_ctx,
        ...
        const DetectBufferMpmRegistery *mpm_reg, int list_id)
{
    ...
    return PrefilterAppendTxEngine(de_ctx, sgh, PrefilterTxHttpRequestBody,
            ...
            pectx, PrefilterMpmHttpRequestBodyFree, mpm_reg->pname);
}
