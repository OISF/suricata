...
static time_t DateStringToEpoch (char *string)
{
    ...
    r = SCStringPatternToTime(string, patterns, 13, &tm);
...
int ValidityTestParse16 (void)
{
    ...
    if (dd) {
        if (dd->epoch == 1420066800 && dd->mode == DETECT_TLS_VALIDITY_EQ)
            result = 1;
...
int ValidityTestParse17 (void)
{
    ...
    if (dd) {
        if (dd->epoch == 1443650400 && dd->mode == DETECT_TLS_VALIDITY_EQ)
            result = 1;
...
int ValidityTestParse18 (void)
{
    ...
    if (dd) {
        if (dd->epoch == 1445464800 && dd->mode == DETECT_TLS_VALIDITY_GT)
            result = 1;
...
int ValidityTestParse19 (void)
{
    ...
    if (dd) {
        if (dd->epoch == 1445547600 && dd->mode == DETECT_TLS_VALIDITY_LT)
            result = 1;
...
int ValidityTestParse20 (void)
{
    ...
    if (dd) {
        if (dd->epoch == 1445551140 && dd->mode == DETECT_TLS_VALIDITY_EQ)
            result = 1;
...
int ValidityTestParse21 (void)
{
    ...
    if (dd) {
        if (dd->epoch == 1445551199 && dd->mode == DETECT_TLS_VALIDITY_EQ)
            result = 1;
...
int ValidityTestParse22 (void)
{
    ...
    if (dd) {
        if (dd->epoch == 1445547600 && dd->mode == DETECT_TLS_VALIDITY_EQ)
            result = 1;
 ...
 * \retval 0 on failure.
 */
int ValidityTestParse25 (void)
{
    int result = 0;
    DetectTlsValidityData *dd = NULL;
    dd = DetectTlsValidityParse("2015-299");
    if (dd) {
        if (dd->epoch == 1445814000 && dd->mode == DETECT_TLS_VALIDITY_EQ)
            result = 1;
...
void TlsNotBeforeRegisterTests(void)
{
    ...
    UtRegisterTest("ValidityTestParse25", ValidityTestParse25, 1);
#endif /* UNITTESTS */
}
