...
void DetectTlsJa3StrRegister(void)
{
    ...
    DetectAppLayerInspectEngineRegister2("ja3_str", ALPROTO_TLS, SIG_FLAG_TOSERVER, 0,
            DetectEngineInspectBufferGeneric, GetData);

    DetectAppLayerMpmRegister2("ja3_str", SIG_FLAG_TOSERVER, 2,
            PrefilterGenericMpmRegister, GetData, ALPROTO_TLS, 0);

    DetectBufferTypeSetDescriptionByName("ja3_str", "TLS JA3 string");
