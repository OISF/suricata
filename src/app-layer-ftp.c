 ...
 */
static AppLayerReturn FTPParseRequest(Flow *f, void *ftp_state,
 ...
 * \retval 1 when the command is parsed, 0 otherwise
 */
static AppLayerReturn FTPParseResponse(Flow *f, void *ftp_state, AppLayerParserState *pstate,
                            const uint8_t *input, uint32_t input_len,
                            void *local_data, const uint8_t flags)
{
    FtpState *state = (FtpState *)ftp_state;
 ...
 * \retval 1 when the command is parsed, 0 otherwise
 */
static AppLayerReturn FTPDataParse(Flow *f, FtpDataState *ftpdata_state,
        AppLayerParserState *pstate,
        const uint8_t *input, uint32_t input_len,
...
static AppLayerReturn FTPDataParseRequest(Flow *f, void *ftp_state,
        AppLayerParserState *pstate,
        const uint8_t *input, uint32_t input_len,
        void *local_data, const uint8_t flags)
{
...
static AppLayerReturn FTPDataParseResponse(Flow *f, void *ftp_state,
        AppLayerParserState *pstate,
        const uint8_t *input, uint32_t input_len,
        void *local_data, const uint8_t flags)
{
