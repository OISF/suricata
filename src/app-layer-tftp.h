...
typedef struct TFTPTransaction_ {
    ...
    TAILQ_ENTRY(TFTPTransaction_) next;

} TFTPTransaction;

typedef struct TFTPState_ {

    TAILQ_HEAD(, TFTPTransaction_) tx_list; /**< List of TFTP transactions
