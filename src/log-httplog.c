                            ...
                            PacketQueue *postpq, int ipproto)
{
    ...
    tx_progress_done_value_ts = AppLayerGetAlstateProgressDoneValue(ALPROTO_HTTP, 0);
    tx_progress_done_value_tc = AppLayerGetAlstateProgressDoneValue(ALPROTO_HTTP, 1);
