...
int32_t dpdkIntelDevSetup(void)
{
    ...
    uint8_t index = DPDKINTEL_GENCFG.Portset, inport = 0;
    int32_t ret = 0;
...
{
    int32_t ret = 0;
    uint8_t inport = 0, outport = 0, portIndex = 0, portBit = 0, i = 0;
...
{
    uint32_t availCpus = getDpdkIntelCpu(),index;
...
uint32_t getDpdkIntelCpu(void)
{
    ...
    uint32_t coreBmp[16] = {0, 1, 3, 7, 15, 31, 63, 127, 255, 511, 1023, 2047, 4095,
