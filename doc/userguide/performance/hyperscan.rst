...
cache files. Suricata will remove cache files older than the specified age
on startup, where age is determined by delta of the file modification time and
the current time.
