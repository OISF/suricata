...
``noalert`` rules, on the other hand, are checked in case their signatures have actions that must be applied to the packet, then suppressed, having no effect in the final alert queue.
