...
* "server_proposals": List of server proposals with parameteres, if there are more than one. This is a non-standard case; this field is only present if such a situation was observed in the inspected traffic.
