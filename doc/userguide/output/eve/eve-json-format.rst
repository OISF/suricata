...
* "type": Either "packet" or "stream". In rare cases, type will be "unknown". When this occurs, an additional field named "code" will be present.
* "event" The name of the anomalous event. Events of type "packet" are prefixed with "decoder"; events of type "stream"
are prefixed with "stream".
