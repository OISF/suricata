...
The following fields and example are for IKEv1, IKEv2 has a different output format. IKEv1 is denoted by the field version_major = 1.
...
* "contained_payload_types_verbose": List of payload types in the current packet, in human-readable form. Needs ``extended: yes`` set in the ``ike`` EVE output option.
...
::
  ...
  "ikev1": {
    "init_spi": "e47a591fd057587f",
    "resp_spi": "a00b8ef0902bb8ec",
    "version_major": 1,
    "version_minor": 0,
