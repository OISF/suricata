...
* "ssh.hassh": MD5 of hassh algorithms of client
* "ssh.hassh.server": MD5 of hassh algorithms of server
* "ssh.hassh.string": hassh algorithms of client
* "ssh.hassh.server.string": hassh algorithms of server
