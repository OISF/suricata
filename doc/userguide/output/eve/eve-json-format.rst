...
The parser implementations for IKEv1 and IKEv2 have a slightly different featureset, you can distinguish between both using the version_major field (which equals either 1 or 2).
The unique properties are contained within a separate ikev1 and ikev2 field.
