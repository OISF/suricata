...
fully buffered: the hello data (SNI, version, ...) is available when
rules in this state are evaluated, and a hello fragmented over several
TLS records keeps the track in ``client_started`` until its final
