...
core team. These items receive full CI (continuous integration)
...
Tier 2 supported items are developed and support by the Suricata core
team, sometimes with help from community. Major functional failures
block git merges and releases, however less major issues may be
documented as "known issues" and may go into a release. Tier 1
