...
htmlhelp_basename = 'suricatadevdoc'
...
latex_documents = [
  (master_doc, 'Suricata.tex', u'Suricata Developer Guide',
   u'OISF', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'Suricata', u'Suricata Developer Guide',
   author, 'Suricata', 'High performance NSM tool',
   'Miscellaneous'),
]
