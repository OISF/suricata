...
`RFC 6895<https://www.iana.org/assignments/dns-parameters/dns-parameters.xhtml#dns-parameters-6>`. 

We plan to extend the the rcode values supported by suricata according to RFC6895 
