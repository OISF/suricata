...
Match on events generated by the Suricata engine.

Syntax::

  engine-event:<event name>;

Example::

  alert ip any any -> any any (engine-event:ipv4.wrong_ip_version; sid:1;)
...
Match on events generated during TCP stream reassembly.
...
Example::
  ...
  alert tcp any any -> any any (stream-event:reassembly_overlap_different_data; sid:1;)
