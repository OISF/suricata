...
Match if the SCTP packet contains an INIT. This is a boolean keyword
...
.. container:: example-rule
    ...
    alert sctp any any -> any any (msg:"SCTP INIT detected"; :example-rule-emphasis:`sctp.has_init;` sid:6; rev:1;)
