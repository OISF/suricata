...
Flowcharts expading uncovered functions or portions of the overall algorithm
...
The IP ONLY rule type is used for rules that match only on source and destination
IPs and port numbers, and not on any other flow or content modifier.
