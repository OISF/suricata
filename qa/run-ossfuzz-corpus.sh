...
do
    ...
    rm -f public.zip
    wget --quiet "https://console.cloud.google.com/storage/browser/_details/suricata-backup.clusterfuzz-external.appspot.com/corpus/libFuzzer/suricata_$target/public.zip"
